...
import org.eclipse.gef3.NodeListener;
import org.eclipse.gef3.Request;

/**
 * Default implementation for {@link org.eclipse.gef3.GraphicalEditPart}.
 * <P>
 ...
 * documentation.
 */
public abstract class AbstractGraphicalEditPart extends org.eclipse.gef3.editparts.AbstractEditPart
	...
	/**
	 * Extends {@link org.eclipse.gef3.editparts.AbstractEditPart#activate()} to also activate all
	 ...
	 * 
	 * @see org.eclipse.gef3.editparts.AbstractEditPart#addChildVisual(EditPart,
	 *      int)
	 */
	...
	/**
	 * @see org.eclipse.gef3.GraphicalEditPart#addNodeListener(org.eclipse.gef3.NodeListener)
	 */
	...
	/**
	 * @see org.eclipse.gef3.EditPart#addNotify()
	 */
	 ...
	 * {@link org.eclipse.gef3.editparts.AbstractEditPart#createChild(Object)}. This method is called
	...
	/**
	 * Extends {@link org.eclipse.gef3.editparts.AbstractEditPart#deactivate()} to also deactivate the
	...
	/**
	 * Extends {@link org.eclipse.gef3.editparts.AbstractEditPart#getAdapter(Class)} to handle additional
	 ...
	 * GraphicalEditParts.
	 * 
	 * @see org.eclipse.gef3.EditPart#getDragTracker(Request)
	 */
	public DragTracker getDragTracker(Request request) {
		return new org.eclipse.gef3.tools.DragEditPartsTracker(this);
	}
	 ...
	 * 
	 * @see org.eclipse.gef3.GraphicalEditPart#getFigure()
	 */
	...
	protected IFigure getLayer(Object layer) {
		org.eclipse.gef3.editparts.LayerManager manager = (org.eclipse.gef3.editparts.LayerManager) getViewer().getEditPartRegistry()
				.get(LayerManager.ID);
	...
	/**
	 * Extends {@link org.eclipse.gef3.editparts.AbstractEditPart#refresh()} to refresh two additional
	 * structural features: <i>source</i> and <i>target</i> connections.
	 * Subclasses should probably override
	 * {@link org.eclipse.gef3.editparts.AbstractEditPart#refreshVisuals()} instead of this method.
	 * 
	 * @see org.eclipse.gef3.EditPart#refresh()
	 */
	public void refresh() {
		super.refresh();
	 ...
	 * 
	 * @see org.eclipse.gef3.editparts.AbstractEditPart#registerVisuals()
	 */
	 ...
	 * 
	 * @see org.eclipse.gef3.editparts.AbstractEditPart#removeChildVisual(EditPart)
	 */
	...
	/**
	 * @see org.eclipse.gef3.GraphicalEditPart#removeNodeListener(org.eclipse.gef3.NodeListener)
	 */
	...
	/**
	 * Extends {@link org.eclipse.gef3.editparts.AbstractEditPart#removeNotify()} to cleanup
	 ...
	 * exists.
	 * 
	 * @see org.eclipse.gef3.editparts.AbstractEditPart#reorderChild(EditPart,
	 *      int)
	 */
