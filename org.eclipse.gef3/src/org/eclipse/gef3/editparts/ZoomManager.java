...
import org.eclipse.gef3.SharedMessages;
...
public class ZoomManager {
	 ...
	 */
	public void addZoomListener(org.eclipse.gef3.editparts.ZoomListener listener) {
	...
	protected void fireZoomChanged() {
		...
		while (iter.hasNext())
			((org.eclipse.gef3.editparts.ZoomListener) iter.next()).zoomChanged(zoom);
	}
