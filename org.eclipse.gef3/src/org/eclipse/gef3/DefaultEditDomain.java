 ...
 * <P>
 * A {@link org.eclipse.gef3.tools.SelectionTool} will be the active Tool until:
 * <UL>
 * <LI>A {@link org.eclipse.gef3.palette.PaletteRoot} is provided which contains
 * a default entry which is a {@link org.eclipse.gef3.palette.ToolEntry}. In
 * which case that entry's tool is made the active Tool.
 * </UL>
 * <P>
 * DefaultEditDomain can be configured with a
 * {@link org.eclipse.gef3.ui.palette.PaletteViewer}. When provided, the
