...
public interface EditPartListener {
	...
	public class Stub implements EditPartListener {
		/**
		 * @see org.eclipse.gef3.EditPartListener#childAdded(EditPart, int)
		 */
		public void childAdded(EditPart child, int index) {
		}

		/**
		 * @see org.eclipse.gef3.EditPartListener#partActivated(EditPart)
		 */
		public void partActivated(EditPart editpart) {
		}

		/**
		 * @see org.eclipse.gef3.EditPartListener#partDeactivated(EditPart)
		 */
		public void partDeactivated(EditPart editpart) {
		}

		/**
		 * @see org.eclipse.gef3.EditPartListener#removingChild(EditPart, int)
		 */
		public void removingChild(EditPart child, int index) {
		}

		/**
		 * @see org.eclipse.gef3.EditPartListener#selectedStateChanged(EditPart)
		 */
