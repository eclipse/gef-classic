...
public class ScrollableSelectionFeedbackEditPolicy extends SelectionEditPolicy {
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.SelectionEditPolicy#activate()
	 */
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.SelectionEditPolicy#deactivate()
	 */
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.SelectionEditPolicy#getFeedbackLayer()
	 */
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.SelectionEditPolicy#hideSelection()
	 */
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.AbstractEditPolicy#setHost(EditPart)
	 */
	...
	protected void showFeedback() {
		...
		List<IFigure> connectionLayerChildren = getLayer(LayerConstants.CONNECTION_LAYER)
				.getChildren();
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.SelectionEditPolicy#showSelection()
	 */
