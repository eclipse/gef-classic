...
/**
 * A palette ToolEntry for a {@link org.eclipse.gef3.tools.MarqueeSelectionTool}.
 * 
 * @author rhudson
 * @author pshah
 * @author anyssen
...
public class MarqueeToolEntry extends ToolEntry {
	...
	/**
	 * @see org.eclipse.gef3.palette.PaletteEntry#getDescription()
	 */
	...
	/**
	 * @see org.eclipse.gef3.palette.PaletteEntry#getLargeIcon()
	 */
	...
	/**
	 * @see org.eclipse.gef3.palette.PaletteEntry#getSmallIcon()
	 */
