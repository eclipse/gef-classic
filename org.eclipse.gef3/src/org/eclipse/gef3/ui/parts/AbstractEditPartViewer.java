...
import org.eclipse.gef3.SelectionManager;
...
public abstract class AbstractEditPartViewer implements EditPartViewer {
	...
	private org.eclipse.gef3.dnd.DelegatingDragAdapter dragAdapter = new org.eclipse.gef3.dnd.DelegatingDragAdapter();

	private DropTarget dropTarget;
	private org.eclipse.gef3.dnd.DelegatingDropAdapter dropAdapter = new org.eclipse.gef3.dnd.DelegatingDropAdapter();
	...
	/**
	 * @see EditPartViewer#addDragSourceListener(org.eclipse.gef3.dnd.TransferDragSourceListener)
	 */
	public void addDragSourceListener(
			org.eclipse.gef3.dnd.TransferDragSourceListener listener) {
	...
	/**
	 * @see EditPartViewer#addDropTargetListener(org.eclipse.gef3.dnd.TransferDropTargetListener)
	 */
	public void addDropTargetListener(
			org.eclipse.gef3.dnd.TransferDropTargetListener listener) {
	 ...
	 */
	protected org.eclipse.gef3.dnd.DelegatingDragAdapter getDelegatingDragAdapter() {
		return dragAdapter;
	}
	 ...
	 * @return <code>null</code> or the adapter
	 */
	protected org.eclipse.gef3.dnd.DelegatingDropAdapter getDelegatingDropAdapter() {
		return dropAdapter;
	}
	...
	/**
	 * @see org.eclipse.gef3.EditPartViewer#getResourceManager()
	 */
	...
	/**
	 * @see EditPartViewer#removeDragSourceListener(org.eclipse.gef3.dnd.TransferDragSourceListener)
	 * @deprecated
	 */
	...
	/**
	 * @see EditPartViewer#removeDropTargetListener(org.eclipse.gef3.dnd.TransferDropTargetListener)
	 * @deprecated
	 */
	...
	/**
	 * @see EditPartViewer#setEditPartFactory(org.eclipse.gef3.EditPartFactory)
	 */
