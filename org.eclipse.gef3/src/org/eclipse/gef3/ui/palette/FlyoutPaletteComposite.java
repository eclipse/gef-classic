...
import org.eclipse.gef3.ui.views.palette.PaletteView;
...
public class FlyoutPaletteComposite extends Composite {
	...
	private static final String PROPERTY_PALETTE_WIDTH = "org.eclipse.gef3.ui.palette.fpa.paletteWidth"; //$NON-NLS-1$
	private static final String PROPERTY_STATE = "org.eclipse.gef3.ui.palette.fpa.state"; //$NON-NLS-1$
	private static final String PROPERTY_DOCK_LOCATION = "org.eclipse.gef3.ui.palette.fpa.dock"; //$NON-NLS-1$
	...
	private static class DefaultFlyoutPreferences implements FlyoutPreferences {
		 ...
		 */
		private static final String PALETTE_DOCK_LOCATION = "org.eclipse.gef3.pdock"; //$NON-NLS-1$
		private static final String PALETTE_SIZE = "org.eclipse.gef3.psize"; //$NON-NLS-1$
		private static final String PALETTE_STATE = "org.eclipse.gef3.pstate"; //$NON-NLS-1$
