...
public abstract class PaletteEditPart extends AbstractGraphicalEditPart
	...
	/**
	 * @see AbstractEditPart#getAccessibleEditPart()
	 */
	...
	public class SingleSelectionTracker extends SelectEditPartTracker {
		...
		/**
		 * @see org.eclipse.gef3.tools.SelectEditPartTracker#performSelection()
		 */
	...
	/**
	 * @see AbstractGraphicalEditPart#getDragTracker(Request)
	 */
	...
	// * stacked).
	// *
	// * @see org.eclipse.gef3.editparts.AbstractGraphicalEditPart#isSelectable()
	// */
	 ...
	 * 
	 * @see AbstractGraphicalEditPart#isSelectable()
	 */
	public boolean isSelectable() {
		// bug #349124
		return true;
