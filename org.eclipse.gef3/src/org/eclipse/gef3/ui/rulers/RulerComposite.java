 ...
 *******************************************************************************/
package org.eclipse.gef3.ui.rulers;
...
import org.eclipse.gef3.internal.ui.rulers.GuideEditPart;
import org.eclipse.gef3.internal.ui.rulers.RulerContextMenuProvider;
import org.eclipse.gef3.internal.ui.rulers.RulerEditPart;
import org.eclipse.gef3.internal.ui.rulers.RulerEditPartFactory;
import org.eclipse.gef3.internal.ui.rulers.RulerRootEditPart;
 ...
 * {@link org.eclipse.gef3.rulers.RulerProvider#PROPERTY_HORIZONTAL_RULER
 * horizontal ruler} and
 * {@link org.eclipse.gef3.rulers.RulerProvider#PROPERTY_VERTICAL_RULER vertical
 * ruler} properties are set on the given viewer, and the value of the
 * {@link org.eclipse.gef3.rulers.RulerProvider#PROPERTY_RULER_VISIBILITY
 * visibility} property.
 * 
 * @author Pratik Shah
 * @since 3.0
...
public class RulerComposite extends Composite {
	...
	private static class RulerViewer extends ScrollingGraphicalViewer {
		...
		/**
		 * @see org.eclipse.gef3.EditPartViewer#appendSelection(org.eclipse.gef3.EditPart)
		 */
		...
		/**
		 * @see org.eclipse.gef3.GraphicalViewer#findHandleAt(Point)
		 */
		...
		/**
		 * @see org.eclipse.gef3.ui.parts.AbstractEditPartViewer#init()
		 */
		protected void init() {
		...
		/**
		 * 
		 * @see org.eclipse.gef3.ui.parts.GraphicalViewerImpl#handleFocusGained(org.eclipse.swt.events.FocusEvent)
		 */
		...
		/**
		 * 
		 * @see org.eclipse.gef3.ui.parts.GraphicalViewerImpl#handleFocusLost(org.eclipse.swt.events.FocusEvent)
		 */
		...
		protected static class RulerKeyHandler extends
			...
			/**
			 * @see org.eclipse.gef3.KeyHandler#keyPressed(org.eclipse.swt.events.KeyEvent)
			 */
