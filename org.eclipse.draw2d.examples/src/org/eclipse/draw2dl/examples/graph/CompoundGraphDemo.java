...
public class CompoundGraphDemo extends AbstractGraphDemo {
	 ...
	 */
	public static org.eclipse.draw2dl.Figure buildGraph(CompoundDirectedGraph graph) {
		org.eclipse.draw2dl.Figure contents = new Panel();
		contents.setFont(new Font(null, "Tahoma", 10, 0));
		contents.setBackgroundColor(org.eclipse.draw2dl.ColorConstants.white);
	...
	private static void buildSubgraphFigure(org.eclipse.draw2dl.Figure contents, Subgraph s) {
		org.eclipse.draw2dl.Figure figure = new org.eclipse.draw2dl.Figure();
