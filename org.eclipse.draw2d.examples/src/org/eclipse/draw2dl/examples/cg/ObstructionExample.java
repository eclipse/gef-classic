...
package org.eclipse.draw2dl.examples.cg;
...
public class ObstructionExample extends AbstractExample {
	...
	static class EllipseDragFigure extends Ellipse {
		...
		public EllipseDragFigure(Point location, boolean isItSource) {
			...
			addMouseListener(new org.eclipse.draw2dl.MouseListener.Stub() {
	...
	class TestFigure extends org.eclipse.draw2dl.Figure {
		...
		public TestFigure() {
			...
			for (int i = 0; i < COUNT; i++) {
				Rectangle bounds = ((org.eclipse.draw2dl.IFigure) obstaclesList.get(i)).getBounds()
						.getCopy();
