...
org.eclipse.draw2dl.IFigure createPageNode(String title) {
...
void doAlignCenter() {
	if (selected == null)
		return;
	TreeBranch parent = (TreeBranch)selected.getParent();
	parent.setAlignment(org.eclipse.draw2dl.PositionConstants.CENTER);
}
...
void doDeleteChild() {
	if (selected == null)
		return;
	TreeBranch parent = (TreeBranch)selected.getParent();
	org.eclipse.draw2dl.IFigure contents = parent.getContentsPane();
