 ...
 * extend {@link org.eclipse.draw2dl.Figure} rather than {@link ImageFigure}).
 * 
 ...
 * @since 3.6
 */
public class GhostImageFigure extends org.eclipse.draw2dl.Figure {
	 ...
	 *            {@link org.eclipse.draw2dl.Graphics#setAlpha(int)}.
	 * @param transparency
	...
	public GhostImageFigure(final IFigure source, int alpha, RGB transparency) {
		...
		org.eclipse.draw2dl.SWTGraphics swtGraphics = new SWTGraphics(gc);
