...
public final class SimpleLoweredBorder extends SchemeBorder {
	...
	private static final Scheme DOUBLE = new Scheme(
			new Color[] { org.eclipse.draw2dl.ColorConstants.buttonDarkest,
					org.eclipse.draw2dl.ColorConstants.buttonDarker },
			new Color[] { org.eclipse.draw2dl.ColorConstants.buttonLightest, ColorConstants.button });
	 ...
	 * {@link SCHEMES#BUTTON_PRESSED} Scheme.
	 * 
	 * @param width
