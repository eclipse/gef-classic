...
public abstract class OrderedLayout extends AbstractHintLayout {
	...
	public OrderedLayout() {
		setHorizontal(getDefaultOrientation() == org.eclipse.draw2dl.PositionConstants.HORIZONTAL);
	 ...
	 * 
	 * @return one of {@link org.eclipse.draw2dl.PositionConstants#HORIZONTAL} or
	 *         {@link org.eclipse.draw2dl.PositionConstants#VERTICAL}
	 */
	...
	private void updateTransposerEnabledState() {
		...
		transposer.setEnabled(isHorizontal()
				&& getDefaultOrientation() == org.eclipse.draw2dl.PositionConstants.VERTICAL
				|| !isHorizontal()
