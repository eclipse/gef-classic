 ...
 * points on a {@link org.eclipse.draw2dl.Connection}.
 */
public class MidpointLocator extends ConnectionLocator {
	 ...
	 * @since 2.0
	 */
	public MidpointLocator(org.eclipse.draw2dl.Connection c, int i) {
		super(c);
		index = i;
	}
	 ...
	 * {@link org.eclipse.draw2dl.Connection} from where midpoint calculation will be made.
	 * 
