 ...
 * {@link #setSelected(org.eclipse.draw2dl.ButtonModel, boolean)} is called. If no default selection
 * is set, the last entry selected is not allowed to deselect.
 */
public class ButtonGroup {

	private org.eclipse.draw2dl.ButtonModel selectedModel;
	private org.eclipse.draw2dl.ButtonModel defaultModel;
	 ...
	 * @since 2.0
	 */
	public void add(org.eclipse.draw2dl.ButtonModel model) {
	...
	protected void firePropertyChange(Object oldValue, Object newValue) {
		PropertyChangeEvent event = new PropertyChangeEvent(this,
				org.eclipse.draw2dl.ButtonModel.SELECTED_PROPERTY, oldValue, newValue);
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.ButtonModel getDefault() {
		return defaultModel;
	}

	/**
	 * Returns a List which contains all of the {@link org.eclipse.draw2dl.ButtonModel ButtonModels}
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.ButtonModel getSelected() {
	 ...
	 * @since 2.0
	 */
	public boolean isSelected(org.eclipse.draw2dl.ButtonModel model) {
	 ...
	 * @since 2.0
	 */
	public void remove(org.eclipse.draw2dl.ButtonModel model) {
	 ...
	 * @since 2.0
	 */
	protected void selectNewModel(org.eclipse.draw2dl.ButtonModel model) {
		org.eclipse.draw2dl.ButtonModel oldModel = selectedModel;
		selectedModel = model;
		if (oldModel != null)
	 ...
	 * @since 2.0
	 */
	public void setDefault(org.eclipse.draw2dl.ButtonModel model) {
		defaultModel = model;
	 ...
	 * @since 2.0
	 */
	public void setSelected(org.eclipse.draw2dl.ButtonModel model) {
		if (model == null)
			selectNewModel(null);
		else
