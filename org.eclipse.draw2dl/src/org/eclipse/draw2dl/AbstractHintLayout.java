 ...
 * {@link #isSensitiveHorizontally(org.eclipse.draw2dl.IFigure)} and
 * {@link #isSensitiveVertically(org.eclipse.draw2dl.IFigure)}. At least one of these method should
...
public abstract class AbstractHintLayout extends AbstractLayout {
	 ...
	 * method is called from {@link #getMinimumSize(org.eclipse.draw2dl.IFigure, int, int)} whenever
	 * the cached minimum size has been flushed.
	 * <P>
	 * By default, this method just calls
	 * {@link #getPreferredSize(org.eclipse.draw2dl.IFigure, int, int)}, meaning minimum and
	...
	/**
	 * @see LayoutManager#getMinimumSize(org.eclipse.draw2dl.IFigure, int, int)
	 */
	public Dimension getMinimumSize(org.eclipse.draw2dl.IFigure container, int w, int h) {
	...
	/**
	 * @see LayoutManager#getPreferredSize(org.eclipse.draw2dl.IFigure, int, int)
	 */
	public final Dimension getPreferredSize(org.eclipse.draw2dl.IFigure container, int w, int h) {
	 ...
	 *         changes
	 */
	protected boolean isSensitiveHorizontally(org.eclipse.draw2dl.IFigure container) {
		return true;
	}
