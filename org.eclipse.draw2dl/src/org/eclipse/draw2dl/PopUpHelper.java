...
public abstract class PopUpHelper {
	...
	private Shell shell;
	private org.eclipse.draw2dl.LightweightSystem lws;
	 ...
	 * @since 2.0
	 */
	protected org.eclipse.draw2dl.LightweightSystem createLightweightSystem() {
		return new org.eclipse.draw2dl.LightweightSystem();
	}
