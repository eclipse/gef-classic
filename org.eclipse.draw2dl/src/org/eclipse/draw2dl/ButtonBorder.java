...
public class ButtonBorder extends SchemeBorder {
	 ...
	 * @see SCHEMES#BUTTON
	 */
	public static final org.eclipse.draw2dl.Border BUTTON = new ButtonBorder(SCHEMES.BUTTON);
	/**
	 * Inverted hightlight colors from BUTTON.
	 * 
	 * @see SCHEMES#BUTTON_CONTRAST
	 */
	public static final org.eclipse.draw2dl.Border BUTTON_CONTRAST = new ButtonBorder(
	 ...
	 */
	public static final org.eclipse.draw2dl.Border BUTTON_SCROLLBAR = new ButtonBorder(
	 ...
	 * buttons. Though similar to the {@link Scheme Scheme} it
	...
	public void paint(IFigure figure, Graphics graphics, Insets insets) {
		org.eclipse.draw2dl.Clickable clickable = (Clickable) figure;
