...
public abstract class AbstractLabeledBorder extends AbstractBorder implements
	 ...
	 * @return The Insets
	 */
	protected abstract Insets calculateInsets(org.eclipse.draw2dl.IFigure figure);
	 ...
	 */
	protected Font getFont(org.eclipse.draw2dl.IFigure f) {
		if (font == null)
			return f.getFont();
		return font;
	}
	 ...
	 * @return The insets
	 */
	public Insets getInsets(org.eclipse.draw2dl.IFigure fig) {
		if (insets == null)
	...
	/**
	 * @see org.eclipse.draw2dl.LabeledBorder#getLabel()
	 */
	...
	/**
	 * @see Border#getPreferredSize(org.eclipse.draw2dl.IFigure)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.LabeledBorder#setLabel(String)
	 */
