 ...
 * {@link org.eclipse.draw2dl.Connection}. <code>uDistance</code> represents the distance from the
...
public class ConnectionEndpointLocator implements Locator {
	...
	private boolean end;
	private org.eclipse.draw2dl.Connection conn;
	...
	/**
	 * Constructs a ConnectionEndpointLocator using the given {@link org.eclipse.draw2dl.Connection}
	 ...
	 * @since 2.0
	 */
	public ConnectionEndpointLocator(org.eclipse.draw2dl.Connection c, boolean isEnd) {
		end = isEnd;
		conn = c;
		uDistance = 14;
		vDistance = 4;
	...
	private org.eclipse.draw2dl.Connection getConnection() {
		return conn;
	}

	private org.eclipse.draw2dl.IFigure getConnectionOwner() {
		org.eclipse.draw2dl.IFigure connOwner;
		if (isEnd())
	 ...
	 * {@link #ConnectionEndpointLocator(org.eclipse.draw2dl.Connection, boolean)}.
	 * 
	 * @param figure
	 *            The figure to relocate
	 */
	public void relocate(org.eclipse.draw2dl.IFigure figure) {
