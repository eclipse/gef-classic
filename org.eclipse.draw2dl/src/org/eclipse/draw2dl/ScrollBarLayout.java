 ...
 */
public class ScrollBarLayout extends org.eclipse.draw2dl.AbstractLayout {
	...
	org.eclipse.draw2dl.IFigure up, down, thumb, pageUp, pageDown;
	 ...
	 */
	public void setConstraint(org.eclipse.draw2dl.IFigure figure, Object constraint) {
	 ...
	 */
	protected Dimension calculatePreferredSize(org.eclipse.draw2dl.IFigure parent, int w, int h) {
	...
	public void layout(org.eclipse.draw2dl.IFigure parent) {
		org.eclipse.draw2dl.ScrollBar scrollBar = (org.eclipse.draw2dl.ScrollBar) parent;
	...
	/**
	 * @see LayoutManager#remove(org.eclipse.draw2dl.IFigure)
	 */
