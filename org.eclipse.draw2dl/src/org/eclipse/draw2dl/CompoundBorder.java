...
public class CompoundBorder extends AbstractBorder {
	...
	/** The inner Border. */
	protected org.eclipse.draw2dl.Border inner;
	/** The outer Border. */
	protected org.eclipse.draw2dl.Border outer;
	 ...
	 * @since 2.0
	 */
	public CompoundBorder(org.eclipse.draw2dl.Border outer, org.eclipse.draw2dl.Border inner) {
		this.outer = outer;
		this.inner = inner;
	}
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.Border getInnerBorder() {
		return inner;
	}
	...
	/**
	 * @see org.eclipse.draw2dl.Border#getPreferredSize(org.eclipse.draw2dl.IFigure)
	 */
