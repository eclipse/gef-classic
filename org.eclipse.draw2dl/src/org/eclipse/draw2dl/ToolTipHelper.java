 ...
 */
public class ToolTipHelper extends org.eclipse.draw2dl.PopUpHelper {

	private Timer timer;
	private org.eclipse.draw2dl.IFigure currentTipSource;
	...
	public ToolTipHelper(org.eclipse.swt.widgets.Control c) {
		...
		getShell().setBackground(org.eclipse.draw2dl.ColorConstants.tooltipBackground);
	 ...
	 */
	private Point computeWindowLocation(org.eclipse.draw2dl.IFigure tip, int eventX, int eventY) {
	 ...
	 * @since 2.0
	 */
	public void displayToolTipNear(org.eclipse.draw2dl.IFigure hoverSource, org.eclipse.draw2dl.IFigure tip,
	 ...
	 * 
	 * @see org.eclipse.draw2dl.PopUpHelper#dispose()
	 */
	public void dispose() {
		if (isShowing()) {
			hide();
	 ...
	 * @since 2.0
	 */
	public void updateToolTip(org.eclipse.draw2dl.IFigure figureUnderMouse, IFigure tip,
                              int eventX, int eventY) {
		/*
