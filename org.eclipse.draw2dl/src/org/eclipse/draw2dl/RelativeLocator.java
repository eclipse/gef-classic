 ...
 * bottom-right corner.
 * <P>
 * Constants such as {@link org.eclipse.draw2dl.PositionConstants#NORTH NORTH} and
 * {@link org.eclipse.draw2dl.PositionConstants#SOUTH SOUTH} can be used to set the placement.
 */
public class RelativeLocator implements Locator {

	private double relativeX;
	private double relativeY;
	private org.eclipse.draw2dl.IFigure reference;
	 ...
	 * location. The location is a constant from {@link org.eclipse.draw2dl.PositionConstants} used
	 ...
	 * @since 2.0
	 */
	public RelativeLocator(org.eclipse.draw2dl.IFigure reference, int location) {
		setReferenceFigure(reference);
		switch (location & org.eclipse.draw2dl.PositionConstants.NORTH_SOUTH) {
		...
		switch (location & org.eclipse.draw2dl.PositionConstants.EAST_WEST) {
	 ...
	 * @since 2.0
	 */
	public RelativeLocator(org.eclipse.draw2dl.IFigure reference, double relativeX, double relativeY) {
		setReferenceFigure(reference);
	 ...
	 * @since 2.0
	 */
	protected org.eclipse.draw2dl.IFigure getReferenceFigure() {
		return reference;
	}
	 ...
	 * 
	 * @see org.eclipse.draw2dl.Locator#relocate(org.eclipse.draw2dl.IFigure)
	 */
	public void relocate(org.eclipse.draw2dl.IFigure target) {
		org.eclipse.draw2dl.IFigure reference = getReferenceFigure();
