...
public class PrintFigureOperation extends PrintOperation {
	...
	private org.eclipse.draw2dl.IFigure printSource;
	 ...
	 * 
	 * @see org.eclipse.draw2dl.PrintOperation#PrintOperation(Printer)
	 */
	 ...
	 *            Figure to print
	 */
	public PrintFigureOperation(Printer p, org.eclipse.draw2dl.IFigure srcFigure) {
		super(p);
	 ...
	 * @see org.eclipse.draw2dl.PrintOperation#getGraphicsOrientation()
	 */
	 ...
	 */
	protected org.eclipse.draw2dl.IFigure getPrintSource() {
		return printSource;
	}

	/**
	 * @see org.eclipse.draw2dl.PrintOperation#preparePrintSource()
	 */
	 ...
	 * 
	 * @see org.eclipse.draw2dl.PrintOperation#printPages()
	 */
	protected void printPages() {
		org.eclipse.draw2dl.Graphics graphics = getFreshPrinterGraphics();
		org.eclipse.draw2dl.IFigure figure = getPrintSource();
	...
	/**
	 * @see org.eclipse.draw2dl.PrintOperation#restorePrintSource()
	 */
	 ...
	 */
	protected void setPrintSource(org.eclipse.draw2dl.IFigure printSource) {
