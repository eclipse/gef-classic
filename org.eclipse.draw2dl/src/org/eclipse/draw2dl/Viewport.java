...
/**
 * A Viewport is a flexible window onto a {@link org.eclipse.draw2dl.ScrollPane} and represents the
 * visible portion of the ScrollPane.
 */
public class Viewport extends org.eclipse.draw2dl.Figure implements PropertyChangeListener {

	/** ID for the view location property */
	public static final String PROPERTY_VIEW_LOCATION = "viewLocation"; //$NON-NLS-1$
	private org.eclipse.draw2dl.IFigure view;
	...
	private org.eclipse.draw2dl.RangeModel horiztonalRangeModel = null, verticalRangeModel = null;

	{
		setLayoutManager(new ViewportLayout());
		setHorizontalRangeModel(new org.eclipse.draw2dl.DefaultRangeModel());
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.RangeModel getHorizontalRangeModel() {
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.RangeModel getVerticalRangeModel() {
	...
	/**
	 * @see org.eclipse.draw2dl.Figure#isCoordinateSystem()
	 */
	...
	/**
	 * Listens for either of the {@link org.eclipse.draw2dl.RangeModel RangeModels} to fire a
	...
	/**
	 * Sets extents of {@link org.eclipse.draw2dl.RangeModel RangeModels} to the client area of this
	 ...
	 * @since 2.0
	 */
	public void setHorizontalRangeModel(org.eclipse.draw2dl.RangeModel rangeModel) {
