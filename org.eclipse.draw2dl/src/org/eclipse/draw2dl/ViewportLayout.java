 ...
 */
public class ViewportLayout extends org.eclipse.draw2dl.AbstractHintLayout {
	...
	protected Dimension calculateMinimumSize(org.eclipse.draw2dl.IFigure figure, int wHint,
                                             int hHint) {
		org.eclipse.draw2dl.Viewport viewport = (org.eclipse.draw2dl.Viewport) figure;
	...
	protected Dimension calculatePreferredSize(org.eclipse.draw2dl.IFigure parent, int wHint,
                                               int hHint) {
		org.eclipse.draw2dl.Viewport viewport = (org.eclipse.draw2dl.Viewport) parent;
		Insets insets = viewport.getInsets();
		org.eclipse.draw2dl.IFigure contents = viewport.getContents();
	...
	/**
	 * @see org.eclipse.draw2dl.AbstractHintLayout#isSensitiveHorizontally(org.eclipse.draw2dl.IFigure)
	 */
	protected boolean isSensitiveHorizontally(org.eclipse.draw2dl.IFigure parent) {
		return ((org.eclipse.draw2dl.Viewport) parent).getContentsTracksWidth();
	}
	...
	protected boolean isSensitiveVertically(org.eclipse.draw2dl.IFigure parent) {
		return ((org.eclipse.draw2dl.Viewport) parent).getContentsTracksHeight();
	}
	...
	public void layout(org.eclipse.draw2dl.IFigure figure) {
		org.eclipse.draw2dl.Viewport viewport = (Viewport) figure;
