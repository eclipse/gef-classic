...
public class ViewportAwareConnectionLayerClippingStrategy implements
	...
	private org.eclipse.draw2dl.ConnectionLayer connectionLayer = null;
	...
	/**
	 * @see org.eclipse.draw2dl.IClippingStrategy#getClip(org.eclipse.draw2dl.IFigure)
	 */
	public Rectangle[] getClip(org.eclipse.draw2dl.IFigure figure) {
		Rectangle[] clipRect = null;
		if (figure instanceof org.eclipse.draw2dl.Connection) {
			clipRect = getEdgeClippingRectangle((org.eclipse.draw2dl.Connection) figure);
		} else {
	 ...
	 */
	protected Rectangle[] getEdgeClippingRectangle(org.eclipse.draw2dl.Connection connection) {
		...
		org.eclipse.draw2dl.ConnectionAnchor sourceAnchor = connection.getSourceAnchor();
		...
		org.eclipse.draw2dl.IFigure sourceFigure = sourceAnchor.getOwner();
		org.eclipse.draw2dl.IFigure targetFigure = targetAnchor.getOwner();
		org.eclipse.draw2dl.Viewport nearestEnclosingCommonViewport = org.eclipse.draw2dl.ViewportUtilities
		...
		// visible at all)
		org.eclipse.draw2dl.Viewport nearestEnclosingSourceViewport = org.eclipse.draw2dl.ViewportUtilities
				.getNearestEnclosingViewport(sourceFigure);
		org.eclipse.draw2dl.Viewport nearestEnclosingTargetViewport = org.eclipse.draw2dl.ViewportUtilities
		...
		if (nearestEnclosingSourceViewport != nearestEnclosingTargetViewport) {
			...
			if (nearestEnclosingSourceViewport != nearestEnclosingCommonViewport) {
				clipAtViewports(sourceClipRect,
						org.eclipse.draw2dl.ViewportUtilities.getViewportsPath(
	 ...
	 * enclosing viewports, excluding the root viewport.
	 */
	protected Rectangle getNodeClippingRectangle(org.eclipse.draw2dl.IFigure figure) {
		...
		// root viewport
		List enclosingViewportsPath = org.eclipse.draw2dl.ViewportUtilities.getViewportsPath(
				org.eclipse.draw2dl.ViewportUtilities.getNearestEnclosingViewport(figure),
	...
	protected void clipAtViewports(Rectangle clipRect,
		...
		for (Iterator iterator = enclosingViewportsPath.iterator(); iterator
				.hasNext();) {
			org.eclipse.draw2dl.Viewport viewport = (org.eclipse.draw2dl.Viewport) iterator.next();
	 ...
	 */
	protected org.eclipse.draw2dl.Viewport getRootViewport() {
	 ...
	 */
	protected Rectangle getAbsoluteClientAreaAsCopy(org.eclipse.draw2dl.IFigure figure) {
