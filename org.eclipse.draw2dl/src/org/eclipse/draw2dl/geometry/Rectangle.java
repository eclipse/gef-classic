 ...
 * Objects.
 */
public class Rectangle implements Cloneable, java.io.Serializable, org.eclipse.draw2dl.geometry.Translatable {
	 ...
	 * @since 2.0
	 */
	public Rectangle(org.eclipse.draw2dl.geometry.Point p, org.eclipse.draw2dl.geometry.Dimension size) {
	 ...
	 * @since 2.0
	 */
	public Rectangle(org.eclipse.draw2dl.geometry.Point p1, org.eclipse.draw2dl.geometry.Point p2) {
	 ...
	 * @since 2.0
	 * @deprecated Use {@link #shrink(org.eclipse.draw2dl.geometry.Insets)} instead.
	 */
	public Rectangle crop(org.eclipse.draw2dl.geometry.Insets insets) {
	 ...
	 * @since 2.0
	 */
	public Rectangle expand(org.eclipse.draw2dl.geometry.Insets insets) {
		x -= insets.left;
		y -= insets.top;
	...
	public org.eclipse.draw2dl.geometry.Point getBottom() {
		return new org.eclipse.draw2dl.geometry.Point(x + width / 2, bottom());
	}
	...
	public org.eclipse.draw2dl.geometry.Point getBottomLeft() {
		return new org.eclipse.draw2dl.geometry.Point(x, y + height);
	}
	...
	public org.eclipse.draw2dl.geometry.Point getBottomRight() {
		return new org.eclipse.draw2dl.geometry.Point(x + width, y + height);
	}
	...
	public org.eclipse.draw2dl.geometry.Point getCenter() {
		return new org.eclipse.draw2dl.geometry.Point(x + width / 2, y + height / 2);
	}
	 ...
	 * @deprecated Use {@link #getShrinked(org.eclipse.draw2dl.geometry.Insets)} instead.
	 */
	public Rectangle getCropped(org.eclipse.draw2dl.geometry.Insets insets) {
	 ...
	 * @since 2.0
	 */
	public Rectangle getExpanded(org.eclipse.draw2dl.geometry.Insets insets) {
	 ...
	 */
	public org.eclipse.draw2dl.geometry.Point getLeft() {
		return new org.eclipse.draw2dl.geometry.Point(x, y + height / 2);
	}
	 ...
	 * @see #setLocation(org.eclipse.draw2dl.geometry.Point)
	 */
	public org.eclipse.draw2dl.geometry.Point getLocation() {
		return new org.eclipse.draw2dl.geometry.Point(x, y);
	}
	 ...
	 * @since 2.0
	 */
	public int getPosition(org.eclipse.draw2dl.geometry.Point p) {
	 ...
	 * @since 2.0
	 */
	public Rectangle getResized(org.eclipse.draw2dl.geometry.Dimension d) {
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.geometry.Point getRight() {
		return new org.eclipse.draw2dl.geometry.Point(right(), y + height / 2);
	}
	 ...
	 * @since 3.7
	 */
	public Rectangle getShrinked(org.eclipse.draw2dl.geometry.Insets insets) {
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.geometry.Dimension getSize() {
		return new org.eclipse.draw2dl.geometry.Dimension(width, height);
	}
	...
	public org.eclipse.draw2dl.geometry.Point getTop() {
		return new org.eclipse.draw2dl.geometry.Point(x + width / 2, y);
	}
	...
	public org.eclipse.draw2dl.geometry.Point getTopRight() {
		return new org.eclipse.draw2dl.geometry.Point(x + width, y);
	}
	 ...
	 * @since 2.0
	 */
	public Rectangle getTranslated(org.eclipse.draw2dl.geometry.Point pt) {
	 ...
	 * @since 3.7
	 */
	public Rectangle getUnion(org.eclipse.draw2dl.geometry.Point p) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Translatable#performScale(double)
	 */
	 ...
	 * @since 2.0
	 */
	public Rectangle resize(org.eclipse.draw2dl.geometry.Dimension d) {
		width += d.width();
		height += d.height();
		return this;
	}
	 ...
	 * @since 3.7
	 */
	public Rectangle setBounds(org.eclipse.draw2dl.geometry.Point location, org.eclipse.draw2dl.geometry.Dimension size) {
	 ...
	 * @since 2.0
	 */
	public Rectangle setLocation(org.eclipse.draw2dl.geometry.Point p) {
	 ...
	 * @since 2.0
	 */
	public Rectangle setSize(org.eclipse.draw2dl.geometry.Dimension d) {
	 ...
	 * @return <code>this</code> for convenience
	 */
	public Rectangle translate(org.eclipse.draw2dl.geometry.Point p) {
		x += p.x;
		y += p.y;
		return this;
	}
	 ...
	 *             {@link org.eclipse.draw2dl.geometry.Dimension#max(org.eclipse.draw2dl.geometry.Dimension, org.eclipse.draw2dl.geometry.Dimension)} and
	 *             {@link #setSize(org.eclipse.draw2dl.geometry.Dimension)} to implement the desired behavior
	 *             instead.
	 */
