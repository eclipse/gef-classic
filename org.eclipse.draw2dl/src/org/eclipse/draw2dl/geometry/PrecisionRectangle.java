 ...
 */
public final class PrecisionRectangle extends org.eclipse.draw2dl.geometry.Rectangle {
	 ...
	 * @since 3.7
	 */
	public PrecisionRectangle(org.eclipse.draw2dl.geometry.Point p, org.eclipse.draw2dl.geometry.Dimension d) {
	 ...
	 *            the base rectangle
	 */
	public PrecisionRectangle(org.eclipse.draw2dl.geometry.Rectangle rect) {
		this(rect.preciseX(), rect.preciseY(), rect.preciseWidth(), rect
				.preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#contains(double, double)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#contains(int, int)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#contains(org.eclipse.draw2dl.geometry.Point)
	 */
	public boolean contains(org.eclipse.draw2dl.geometry.Point p) {
		return containsPrecise(p.preciseX(), p.preciseY());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#contains(org.eclipse.draw2dl.geometry.Rectangle)
	 */
	public boolean contains(org.eclipse.draw2dl.geometry.Rectangle rect) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#equals(Object)
	 */
	 ...
	 * @since 3.4
	 */
	public org.eclipse.draw2dl.geometry.Rectangle expand(double h, double v) {
		return expandPrecise(h, v);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#expand(org.eclipse.draw2dl.geometry.Insets)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle expand(org.eclipse.draw2dl.geometry.Insets insets) {
		if (insets == null)
			return this;
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#expand(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle expand(int h, int v) {
		return expandPrecise(h, v);
	}
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#getBottom()
	 */
	public org.eclipse.draw2dl.geometry.Point getBottom() {
		return new org.eclipse.draw2dl.geometry.PrecisionPoint(preciseX() + preciseWidth() / 2, bottom());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#getBottomLeft()
	 */
	public org.eclipse.draw2dl.geometry.Point getBottomLeft() {
		return new org.eclipse.draw2dl.geometry.PrecisionPoint(preciseX(), preciseY() + preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#getBottomRight()
	 */
	public org.eclipse.draw2dl.geometry.Point getBottomRight() {
		return new org.eclipse.draw2dl.geometry.PrecisionPoint(preciseX() + preciseWidth(), preciseY()
				+ preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#getCenter()
	 */
	public org.eclipse.draw2dl.geometry.Point getCenter() {
		return new org.eclipse.draw2dl.geometry.PrecisionPoint(preciseX() + preciseWidth() / 2.0, preciseY()
				+ preciseHeight() / 2.0);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#getCopy()
	 */
	public org.eclipse.draw2dl.geometry.Rectangle getCopy() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#getTop()
	 */
	public org.eclipse.draw2dl.geometry.Point getTop() {
		return new org.eclipse.draw2dl.geometry.PrecisionPoint(preciseX() + preciseWidth() / 2, preciseY());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#getTopLeft()
	 */
	public org.eclipse.draw2dl.geometry.Point getTopLeft() {
		return new org.eclipse.draw2dl.geometry.PrecisionPoint(preciseX(), preciseY());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#getTopRight()
	 */
	public org.eclipse.draw2dl.geometry.Point getTopRight() {
		return new org.eclipse.draw2dl.geometry.PrecisionPoint(preciseX() + preciseWidth(), preciseY());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#intersect(org.eclipse.draw2dl.geometry.Rectangle)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle intersect(org.eclipse.draw2dl.geometry.Rectangle rect) {
	 ...
	 * @since 3.7
	 */
	private PrecisionRectangle intersectPrecise(org.eclipse.draw2dl.geometry.Rectangle rect) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#performScale(double)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#performTranslate(int, int)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#preciseHeight()
	 */
	public double preciseHeight() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#preciseWidth()
	 */
	public double preciseWidth() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#preciseX()
	 */
	public double preciseX() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#preciseY()
	 */
	public double preciseY() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#resize(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle resize(org.eclipse.draw2dl.geometry.Dimension d) {
		return resizePrecise(d.preciseWidth(), d.preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#resize(double, double)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle resize(double w, double h) {
		return resizePrecise(w, h);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#resize(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle resize(int w, int h) {
		return resizePrecise(w, h);
	}
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setBounds(int, int, int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setBounds(int x, int y, int width, int height) {
		return setPreciseBounds(x, y, width, height);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setBounds(org.eclipse.draw2dl.geometry.Point,
	 *      org.eclipse.draw2dl.geometry.Dimension)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setBounds(org.eclipse.draw2dl.geometry.Point location, org.eclipse.draw2dl.geometry.Dimension size) {
		return setPreciseBounds(location.preciseX(), location.preciseY(),
				size.preciseWidth(), size.preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setBounds(org.eclipse.draw2dl.geometry.Rectangle)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setBounds(org.eclipse.draw2dl.geometry.Rectangle rect) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setHeight(int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setHeight(int height) {
		return setPreciseHeight(height);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setLocation(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setLocation(int x, int y) {
		return setPreciseLocation(x, y);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setLocation(org.eclipse.draw2dl.geometry.Point)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setLocation(org.eclipse.draw2dl.geometry.Point loc) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setSize(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setSize(Dimension d) {
		return setPreciseSize(d.preciseWidth(), d.preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setSize(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setSize(int w, int h) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setWidth(int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setWidth(int width) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setX(int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setX(int value) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#setY(int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle setY(int value) {
	 ...
	 * @since 3.4
	 */
	public org.eclipse.draw2dl.geometry.Rectangle shrink(double h, double v) {
		return shrinkPrecise(h, v);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#shrink(org.eclipse.draw2dl.geometry.Insets)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle shrink(Insets insets) {
		if (insets == null)
			return this;
		setPreciseX(preciseX() + insets.left);
		setPreciseY(preciseY() + insets.top);
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#shrink(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle shrink(int h, int v) {
		return shrinkPrecise(h, v);
	}
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#touches(org.eclipse.draw2dl.geometry.Rectangle)
	 */
	public boolean touches(org.eclipse.draw2dl.geometry.Rectangle rect) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#translate(double, double)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle translate(double dx, double dy) {
		return translatePrecise(dx, dy);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#translate(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle translate(int dx, int dy) {
		return translatePrecise(dx, dy);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#translate(org.eclipse.draw2dl.geometry.Point)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle translate(org.eclipse.draw2dl.geometry.Point p) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#transpose()
	 */
	public org.eclipse.draw2dl.geometry.Rectangle transpose() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#union(double, double)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle union(double x, double y) {
		return unionPrecise(x, y);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#union(double, double, double,
	 *      double)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle union(double x, double y, double w, double h) {
		return unionPrecise(x, y, w, h);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#union(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle union(int x, int y) {
		return unionPrecise(x, y);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#union(int, int, int, int)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle union(int x, int y, int w, int h) {
		return unionPrecise(x, y, w, h);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#union(org.eclipse.draw2dl.geometry.Point)
	 */
	 ...
	 * @return <code>this</code> for convenience
	 * @deprecated Use {@link #union(org.eclipse.draw2dl.geometry.Rectangle)} instead
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Rectangle#union(org.eclipse.draw2dl.geometry.Rectangle)
	 */
	public org.eclipse.draw2dl.geometry.Rectangle union(Rectangle rect) {
		if (rect == null || rect.isEmpty())
			return this;
		return unionPrecise(rect.preciseX(), rect.preciseY(),
				rect.preciseWidth(), rect.preciseHeight());
	...
	private final void updateHeightInt() {
		height = org.eclipse.draw2dl.geometry.PrecisionGeometry.doubleToInteger(preciseHeight);
	}
	...
	private final void updatePreciseHeightDouble() {
		if (height != org.eclipse.draw2dl.geometry.PrecisionGeometry.doubleToInteger(preciseHeight)) {
	...
	private final void updatePreciseWidthDouble() {
		if (width != org.eclipse.draw2dl.geometry.PrecisionGeometry.doubleToInteger(preciseWidth)) {
			preciseWidth = width;
		}
	}
	...
	private final void updatePreciseXDouble() {
		if (x != org.eclipse.draw2dl.geometry.PrecisionGeometry.doubleToInteger(preciseX)) {
			preciseX = x;
		}
	}
	...
	private final void updatePreciseYDouble() {
		if (y != org.eclipse.draw2dl.geometry.PrecisionGeometry.doubleToInteger(preciseY)) {
			preciseY = y;
		}
	}
	...
	private final void updateWidthInt() {
		width = org.eclipse.draw2dl.geometry.PrecisionGeometry.doubleToInteger(preciseWidth);
	}
	...
	private final void updateXInt() {
		x = org.eclipse.draw2dl.geometry.PrecisionGeometry.doubleToInteger(preciseX);
	}
