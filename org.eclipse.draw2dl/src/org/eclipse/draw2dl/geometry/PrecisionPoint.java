 ...
 * @author danlee
 */
public class PrecisionPoint extends org.eclipse.draw2dl.geometry.Point {
	 ...
	 */
	public PrecisionPoint(org.eclipse.draw2dl.geometry.Point p) {
		this(p.preciseX(), p.preciseY());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Point#equals(java.lang.Object)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#getCopy()
	 */
	public org.eclipse.draw2dl.geometry.Point getCopy() {
		return getPreciseCopy();
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Point#getDifference(org.eclipse.draw2dl.geometry.Point)
	 */
	public org.eclipse.draw2dl.geometry.Dimension getDifference(org.eclipse.draw2dl.geometry.Point p) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#performScale(double)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#performTranslate(int, int)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#preciseX()
	 */
	public double preciseX() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#preciseY()
	 */
	public double preciseY() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#scale(double, double)
	 */
	public org.eclipse.draw2dl.geometry.Point scale(double xFactor, double yFactor) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#setLocation(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Point setLocation(int x, int y) {
		return setPreciseLocation(x, y);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Point#setLocation(org.eclipse.draw2dl.geometry.Point)
	 */
	public org.eclipse.draw2dl.geometry.Point setLocation(org.eclipse.draw2dl.geometry.Point pt) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#setX(int)
	 */
	public org.eclipse.draw2dl.geometry.Point setX(int x) {
		return setPreciseX(x);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Point#setY(int)
	 */
	public org.eclipse.draw2dl.geometry.Point setY(int y) {
		return setPreciseY(y);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Point#translate(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public org.eclipse.draw2dl.geometry.Point translate(Dimension d) {
		return translatePrecise(d.preciseWidth(), d.preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Point#translate(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Point translate(int dx, int dy) {
		return translatePrecise(dx, dy);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Point#translate(double, double)
	 */
	public org.eclipse.draw2dl.geometry.Point translate(double dx, double dy) {
		return translatePrecise(dx, dy);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Point#translate(org.eclipse.draw2dl.geometry.Point)
	 */
	public org.eclipse.draw2dl.geometry.Point translate(org.eclipse.draw2dl.geometry.Point p) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Point#transpose()
	 */
	...
	private final void updateYInt() {
		y = org.eclipse.draw2dl.geometry.PrecisionGeometry.doubleToInteger(preciseY);
	}
