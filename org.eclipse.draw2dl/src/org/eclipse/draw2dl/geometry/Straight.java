...
public class Straight {
	...
	public org.eclipse.draw2dl.geometry.Vector position;

	/** direction vector of this straight */
	public org.eclipse.draw2dl.geometry.Vector direction;
	 ...
	 * @param direction
	 */
	public Straight(org.eclipse.draw2dl.geometry.Vector position, org.eclipse.draw2dl.geometry.Vector direction) {
		if (direction.isNull()) {
	 ...
	 */
	public Straight(org.eclipse.draw2dl.geometry.PrecisionPoint point1, PrecisionPoint point2) {
		this(new org.eclipse.draw2dl.geometry.Vector(point1), new org.eclipse.draw2dl.geometry.Vector(point1, point2));
	}
	 ...
	 * @since 3.2
	 */
	public boolean intersectsWithinSegment(org.eclipse.draw2dl.geometry.Vector segmentStart,
                                           org.eclipse.draw2dl.geometry.Vector segmentEnd, Straight other) {
		...
		// point
		org.eclipse.draw2dl.geometry.Vector segmentDirection = segmentEnd.getSubtracted(segmentStart);
		...
		if (intersects(other)) {
			org.eclipse.draw2dl.geometry.Vector intersection = getIntersection(other);
	 ...
	 */
	public org.eclipse.draw2dl.geometry.Vector getIntersection(Straight other) {
		// first check if there is a single intersection point
		if (!intersects(other)) {
			return null;
		}
		// calculate intersection point
		org.eclipse.draw2dl.geometry.Vector s1 = direction.getMultiplied(other.position
				.getDotProduct(other.direction.getOrthogonalComplement()));
		org.eclipse.draw2dl.geometry.Vector s2 = other.direction.getMultiplied(position
	 ...
	 *         onto this Straight.
	 */
	public org.eclipse.draw2dl.geometry.Vector getProjection(org.eclipse.draw2dl.geometry.Vector vector) {
	 ...
	 */
	public double getDistance(org.eclipse.draw2dl.geometry.Vector vector) {
	 ...
	 */
	public boolean contains(org.eclipse.draw2dl.geometry.Vector vector) {
	 ...
	 */
	public boolean containsWithinSegment(org.eclipse.draw2dl.geometry.Vector segmentStart,
                                         org.eclipse.draw2dl.geometry.Vector segmentEnd, org.eclipse.draw2dl.geometry.Vector vector) {
		// precondition: segment start and end have to be points on this
		// straight.
		if (!contains(segmentStart) || !contains(segmentEnd)) {
			throw new IllegalArgumentException(
