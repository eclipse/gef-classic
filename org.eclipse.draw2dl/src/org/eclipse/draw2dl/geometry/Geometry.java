...
public class Geometry {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.PointList#polylineContainsPoint(int, int, int)
	 * @since 3.5
	 */
	public static boolean polylineContainsPoint(org.eclipse.draw2dl.geometry.PointList points, int x, int y,
                                                int tolerance) {
	...
	private static boolean segmentContainsPoint(int x1, int y1, int x2, int y2,
		 ...
		 */
		org.eclipse.draw2dl.geometry.Rectangle lineBounds = Rectangle.SINGLETON;
	 ...
	 * 
	 * @see org.eclipse.draw2dl.geometry.PointList#polygonContainsPoint(int, int)
	 * @since 3.5
	 */
