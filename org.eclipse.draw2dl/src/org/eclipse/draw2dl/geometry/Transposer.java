...
public class Transposer {
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.geometry.Dimension t(Dimension d) {
		if (isEnabled())
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.geometry.Insets t(Insets i) {
		if (isEnabled())
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.geometry.Point t(Point p) {
		if (isEnabled())
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.geometry.Rectangle t(Rectangle r) {
		if (isEnabled())
