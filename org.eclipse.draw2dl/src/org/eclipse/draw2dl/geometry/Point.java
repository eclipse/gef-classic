 ...
 * Objects.
 */
public class Point implements Cloneable, java.io.Serializable, org.eclipse.draw2dl.geometry.Translatable {
	...
	public static Point max(Point p1, Point p2) {
		return new org.eclipse.draw2dl.geometry.Rectangle(p1, p2).getBottomRight().translate(-1, -1);
	}
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.geometry.Dimension getDifference(Point p) {
		return new org.eclipse.draw2dl.geometry.Dimension(this.x - p.x(), this.y - p.y());
	}
	 ...
	 * @since 2.0
	 */
	public Point getTranslated(org.eclipse.draw2dl.geometry.Dimension d) {
