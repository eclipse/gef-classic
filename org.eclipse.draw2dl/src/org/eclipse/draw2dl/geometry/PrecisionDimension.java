 ...
 * @author Randy Hudson
 */
public class PrecisionDimension extends org.eclipse.draw2dl.geometry.Dimension {
	 ...
	 */
	public PrecisionDimension(org.eclipse.draw2dl.geometry.Dimension d) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#contains(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public boolean contains(org.eclipse.draw2dl.geometry.Dimension d) {
		return preciseWidth() >= d.preciseWidth()
				&& preciseHeight() >= d.preciseHeight();
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#containsProper(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public boolean containsProper(org.eclipse.draw2dl.geometry.Dimension d) {
		return preciseWidth() > d.preciseWidth()
				&& preciseHeight() > d.preciseHeight();
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#equals(java.lang.Object)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#expand(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public org.eclipse.draw2dl.geometry.Dimension expand(org.eclipse.draw2dl.geometry.Dimension d) {
		return expandPrecise(d.preciseWidth(), d.preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#expand(double, double)
	 */
	public org.eclipse.draw2dl.geometry.Dimension expand(double w, double h) {
		return expandPrecise(w, h);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#expand(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Dimension expand(int w, int h) {
		return expandPrecise(w, h);
	}
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#getCopy()
	 */
	public org.eclipse.draw2dl.geometry.Dimension getCopy() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#intersect(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public org.eclipse.draw2dl.geometry.Dimension intersect(org.eclipse.draw2dl.geometry.Dimension d) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#performScale(double)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#preciseHeight()
	 */
	public double preciseHeight() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#preciseWidth()
	 */
	public double preciseWidth() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#scale(double, double)
	 */
	public org.eclipse.draw2dl.geometry.Dimension scale(double widthFactor, double heightFactor) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#setHeight(int)
	 */
	public org.eclipse.draw2dl.geometry.Dimension setHeight(int h) {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#setSize(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public void setSize(org.eclipse.draw2dl.geometry.Dimension d) {
		setPreciseSize(d.preciseWidth(), d.preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#setSize(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Dimension setSize(int w, int h) {
		return setPreciseSize(w, h);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#setWidth(int)
	 */
	public org.eclipse.draw2dl.geometry.Dimension setWidth(int width) {
		return setPreciseWidth(width);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#shrink(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public org.eclipse.draw2dl.geometry.Dimension shrink(org.eclipse.draw2dl.geometry.Dimension d) {
		return shrinkPrecise(d.preciseWidth(), d.preciseHeight());
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#shrink(int, int)
	 */
	public org.eclipse.draw2dl.geometry.Dimension shrink(int w, int h) {
		return shrinkPrecise(w, h);
	}

	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#shrink(double, double)
	 */
	public org.eclipse.draw2dl.geometry.Dimension shrink(double w, double h) {
		return shrinkPrecise(w, h);
	}
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#transpose()
	 */
	public org.eclipse.draw2dl.geometry.Dimension transpose() {
	...
	/**
	 * @see org.eclipse.draw2dl.geometry.Dimension#union(org.eclipse.draw2dl.geometry.Dimension)
	 */
	public org.eclipse.draw2dl.geometry.Dimension union(Dimension d) {
