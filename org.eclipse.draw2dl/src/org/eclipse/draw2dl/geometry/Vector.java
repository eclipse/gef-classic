...
public class Vector {
	 ...
	 *            the point
	 */
	public Vector(org.eclipse.draw2dl.geometry.PrecisionPoint p) {
		x = p.preciseX();
		y = p.preciseY();
	}
	 ...
	 *            End Point
	 */
	public Vector(org.eclipse.draw2dl.geometry.PrecisionPoint start, org.eclipse.draw2dl.geometry.PrecisionPoint end) {
	...
	public double getDissimilarity(Vector other) {
		return org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseAbs(getCrossProduct(other));
	}
	...
	public double getDotProduct(Vector other) {
		return org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseAdd(
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseMultiply(x, other.x),
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseMultiply(y, other.y));
	}
	...
	public double getCrossProduct(Vector other) {
		return org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseSubtract(
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseMultiply(x, other.y),
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseMultiply(y, other.x));
	}
	...
	public Vector getAdded(Vector other) {
		return new Vector(org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseAdd(x, other.x),
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseAdd(y, other.y));
	}
	...
	public Vector getSubtracted(Vector other) {
		return new Vector(org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseSubtract(x, other.x),
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseSubtract(y, other.y));
	}
	...
	public double getAngle(Vector other) {
		double cosAlpha = org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseDivide(
				getDotProduct(other),
				(org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseMultiply(getLength(),
						other.getLength())));
	...
	public Vector getAveraged(Vector other) {
		return new Vector(org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseDivide(
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseAdd(x, other.x), 2),
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseDivide(
						org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseAdd(y, other.y), 2));
	}
	...
	public Vector getMultiplied(double factor) {
		return new Vector(org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseMultiply(x, factor),
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseMultiply(y, factor));
	}
	...
	public Vector getDivided(double factor) {
		return new Vector(org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseDivide(x, factor),
				org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseDivide(y, factor));
	}
	...
	public Vector getOrthogonalComplement() {
		return new Vector(org.eclipse.draw2dl.geometry.PrecisionGeometry.preciseNegate(y), x);
	}
	 ...
	 */
	public org.eclipse.draw2dl.geometry.PrecisionPoint toPoint() {
