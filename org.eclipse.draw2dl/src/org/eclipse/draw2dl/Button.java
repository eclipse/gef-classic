...
public class Button extends Clickable {
	...
	public Button(Image image) {
		super(new org.eclipse.draw2dl.Label(image), STYLE_BUTTON);
	}
	...
	public Button(String text) {
		super(new org.eclipse.draw2dl.Label(text), STYLE_BUTTON);
	}
	 ...
	 * background color to {@link org.eclipse.draw2dl.ColorConstants#button}.
	 * 
	 * @since 2.0
	 */
	protected void init() {
