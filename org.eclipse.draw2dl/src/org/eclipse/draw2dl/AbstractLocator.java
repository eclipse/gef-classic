...
public abstract class AbstractLocator implements Locator {
	...
	private int relativePosition = org.eclipse.draw2dl.PositionConstants.CENTER;
	private int gap;
	 ...
	 * returns something other than {@link org.eclipse.draw2dl.PositionConstants#CENTER}.
	 * 
	 * @return The gap
	 * @since 2.0
	 */
	...
	protected Rectangle getNewBounds(Dimension size, Point center) {
		...
		if ((position & org.eclipse.draw2dl.PositionConstants.NORTH) != 0)
			yFactor = -1;
		else if ((position & org.eclipse.draw2dl.PositionConstants.SOUTH) != 0)
			yFactor = 1;

		if ((position & org.eclipse.draw2dl.PositionConstants.WEST) != 0)
			xFactor = -1;
		else if ((position & org.eclipse.draw2dl.PositionConstants.EAST) != 0)
			xFactor = 1;
	 ...
	 * Possible values can be found in {@link org.eclipse.draw2dl.PositionConstants} and include
