...
/**
 * Places a figure relative to a specified bend in a {@link org.eclipse.draw2dl.Connection}. A
 * bendpoint is one of the points returned in the connection's
 * {@link org.eclipse.draw2dl.Connection#getPoints()} method. It is not related to the bendpoint
...
public class BendpointLocator extends ConnectionLocator {
	 ...
	 * @since 2.0
	 */
	public BendpointLocator(org.eclipse.draw2dl.Connection c, int i) {
		super(c);
		index = i;
	}
