...
public abstract class AbstractLayout implements LayoutManager {
	...
	/**
	 * This method is now {@link #calculatePreferredSize(org.eclipse.draw2dl.IFigure, int, int)}.
	 * 
	 * @param container
	 *            the figure
	 */
	protected final void calculatePreferredSize(org.eclipse.draw2dl.IFigure container) {
	}
	 ...
	 */
	protected abstract Dimension calculatePreferredSize(org.eclipse.draw2dl.IFigure container,
                                                        int wHint, int hHint);
	 ...
	 */
	protected Dimension getBorderPreferredSize(org.eclipse.draw2dl.IFigure container) {
	...
	/**
	 * This method is now {@link #getMinimumSize(org.eclipse.draw2dl.IFigure, int, int)}.
	 * 
	 * @param container
	 *            the figure
	 */
	public final void getMinimumSize(org.eclipse.draw2dl.IFigure container) {
	}

	/**
	 * @see org.eclipse.draw2dl.LayoutManager#getMinimumSize(org.eclipse.draw2dl.IFigure, int, int)
	 */
	 ...
	 * {@link #calculatePreferredSize(org.eclipse.draw2dl.IFigure, int, int)} is called.
	 * 
	 * @param container
	 *            The figure
	 * @param wHint
	 ...
	 * @return The preferred size
	 */
	public Dimension getPreferredSize(org.eclipse.draw2dl.IFigure container, int wHint, int hHint) {
	...
	/**
	 * This method is now {@link #getPreferredSize(org.eclipse.draw2dl.IFigure, int, int)}.
	 * 
	 * @param container
	 *            the figure
	 */
	public final void getPreferredSize(org.eclipse.draw2dl.IFigure container) {
	}

	/**
	 * @see org.eclipse.draw2dl.LayoutManager#invalidate()
	 */
	 ...
	 */
	protected void invalidate(org.eclipse.draw2dl.IFigure child) {
		invalidate();
	}
