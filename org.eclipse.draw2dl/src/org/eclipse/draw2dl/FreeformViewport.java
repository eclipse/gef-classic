...
/**
 * A viewport for {@link org.eclipse.draw2dl.FreeformFigure FreeformFigures}.
 * FreeformFigures can only reside in this type of viewport.
 */
public class FreeformViewport extends org.eclipse.draw2dl.Viewport {
	...
	class FreeformViewportLayout extends ViewportLayout {
		protected Dimension calculatePreferredSize(org.eclipse.draw2dl.IFigure parent, int wHint,
			...
			return ((org.eclipse.draw2dl.FreeformFigure) getContents()).getFreeformExtent()
	...
	protected void readjustScrollBars() {
		if (getContents() == null)
			return;
		if (!(getContents() instanceof org.eclipse.draw2dl.FreeformFigure))
			return;
		org.eclipse.draw2dl.FreeformFigure ff = (FreeformFigure) getContents();
