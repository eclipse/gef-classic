...
/**
 * Repositions a {@link Figure} attached to a {@link org.eclipse.draw2dl.Connection} when the
...
public class ConnectionLocator extends AbstractLocator {
	...
	private org.eclipse.draw2dl.Connection connection;
	 ...
	 * @since 2.0
	 */
	public ConnectionLocator(org.eclipse.draw2dl.Connection connection) {
	 ...
	 * @since 2.0
	 */
	public ConnectionLocator(org.eclipse.draw2dl.Connection connection, int align) {
	 ...
	 * @since 2.0
	 */
	protected org.eclipse.draw2dl.Connection getConnection() {
		return connection;
	}
