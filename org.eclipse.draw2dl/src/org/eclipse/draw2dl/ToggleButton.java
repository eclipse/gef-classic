...
public class ToggleButton extends Toggle {
	...
	protected org.eclipse.draw2dl.Label label = null;
	 ...
	 */
	protected void paintFigure(org.eclipse.draw2dl.Graphics graphics) {
	...
	protected void fillCheckeredRectangle(Graphics graphics) {
		graphics.setBackgroundColor(org.eclipse.draw2dl.ColorConstants.button);
