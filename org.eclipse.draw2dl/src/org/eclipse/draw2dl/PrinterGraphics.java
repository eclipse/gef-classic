...
public class PrinterGraphics extends ScaledGraphics {
	 ...
	 *            Printer to print to
	 */
	public PrinterGraphics(org.eclipse.draw2dl.Graphics g, Printer p) {
		super(g);
		printer = p;
	}
	...
	/**
	 * @see org.eclipse.draw2dl.ScaledGraphics#dispose()
	 */
	public void dispose() {
		super.dispose();
	...
	/**
	 * @see org.eclipse.draw2dl.ScaledGraphics#zoomLineWidth(float)
	 */
	 ...
	 * 
	 * @see org.eclipse.draw2dl.ScaledGraphics#setLineAttributes(org.eclipse.swt.graphics.LineAttributes)
	 */
