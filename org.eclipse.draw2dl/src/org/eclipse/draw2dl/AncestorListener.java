...
public interface AncestorListener {
	 ...
	 */
	void ancestorAdded(org.eclipse.draw2dl.IFigure ancestor);
	 ...
	 */
	void ancestorMoved(org.eclipse.draw2dl.IFigure ancestor);
	 ...
	 */
	void ancestorRemoved(org.eclipse.draw2dl.IFigure ancestor);

	/**
	 * An empty implementation of AncestorListener for convenience.
	 */
	class Stub implements AncestorListener {
		public void ancestorMoved(org.eclipse.draw2dl.IFigure ancestor) {
		}
