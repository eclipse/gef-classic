 ...
 */
public class FlowLayout extends org.eclipse.draw2dl.OrderedLayout {
	...
	protected class WorkingData {
		...
		public org.eclipse.draw2dl.IFigure row[];
	 ...
	 * 
	 * @deprecated Use {@link org.eclipse.draw2dl.OrderedLayout#ALIGN_TOPLEFT} instead.
	 */
	 ...
	 * 
	 * @deprecated Use {@link org.eclipse.draw2dl.OrderedLayout#ALIGN_BOTTOMRIGHT} instead.
	 */
	 ...
	 * 
	 * @deprecated Use {@link org.eclipse.draw2dl.OrderedLayout#setStretchMinorAxis(boolean)} and
	...
	/**
	 * @see AbstractLayout#calculatePreferredSize(org.eclipse.draw2dl.IFigure,
	 *      int, int)
	 */
	 ...
	 */
	protected Dimension getChildSize(org.eclipse.draw2dl.IFigure child, int wHint, int hHint) {
		return child.getPreferredSize(wHint, hHint);
	}

	/**
	 * Returns {@link org.eclipse.draw2dl.PositionConstants#HORIZONTAL} by default.
	 * 
	 * @see org.eclipse.draw2dl.OrderedLayout#getDefaultOrientation()
	 */
	 ...
	 * @since 2.0
	 */
	protected void initVariables(org.eclipse.draw2dl.IFigure parent) {
		data.row = new org.eclipse.draw2dl.IFigure[parent.getChildren().size()];
		data.bounds = new Rectangle[data.row.length];
		data.maxWidth = data.area.width;
	}

	/**
	 * @see AbstractHintLayout#isSensitiveHorizontally(org.eclipse.draw2dl.IFigure)
	 */
	protected boolean isSensitiveHorizontally(org.eclipse.draw2dl.IFigure parent) {
		return isHorizontal();
	}

	/**
	 * @see AbstractHintLayout#isSensitiveVertically(org.eclipse.draw2dl.IFigure)
	 */
	protected boolean isSensitiveVertically(org.eclipse.draw2dl.IFigure parent) {
		return !isHorizontal();
	}
	 ...
	 * field.
	 * 
	 * @see org.eclipse.draw2dl.OrderedLayout#isStretchMinorAxis()
	 */
	 ...
	 * @since 2.0
	 */
	protected void setBoundsOfChild(org.eclipse.draw2dl.IFigure parent, IFigure child,
                                    Rectangle bounds) {
	 ...
	 * field.
	 * 
	 * @see org.eclipse.draw2dl.OrderedLayout#setStretchMinorAxis(boolean)
	 */
