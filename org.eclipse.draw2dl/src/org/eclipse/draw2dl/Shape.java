 ...
 */
public abstract class Shape extends org.eclipse.draw2dl.Figure {
	 ...
	 *            the graphics object
	 */
	protected abstract void fillShape(org.eclipse.draw2dl.Graphics graphics);
	 ...
	 *            the graphics object
	 */
	protected abstract void outlineShape(org.eclipse.draw2dl.Graphics graphics);
	 ...
	 */
	public void paintFigure(org.eclipse.draw2dl.Graphics graphics) {
		if (antialias != null) {
		...
		if (!isEnabled()) {
			...
			graphics.setBackgroundColor(org.eclipse.draw2dl.ColorConstants.buttonLightest);
			...
			graphics.setBackgroundColor(org.eclipse.draw2dl.ColorConstants.buttonDarker);
	...
	private void paintOutline(org.eclipse.draw2dl.Graphics graphics) {
	...
	public LineAttributes getLineAttributes() {
		return org.eclipse.draw2dl.SWTGraphics.clone(lineAttributes);
	}
