...
class BufferedGraphicsSource implements GraphicsSource {
	...
	/**
	 * @see org.eclipse.draw2dl.GraphicsSource#flushGraphics(Rectangle)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.GraphicsSource#getGraphics(Rectangle)
	 */
	public org.eclipse.draw2dl.Graphics getGraphics(Rectangle region) {
		...
		if (imageBuffer != null) {
			...
			graphics = new org.eclipse.draw2dl.SWTGraphics(imageGC);
