 ...
 */
public class ToolbarLayout extends org.eclipse.draw2dl.OrderedLayout {
	 ...
	 * @see #getMinimumSize(org.eclipse.draw2dl.IFigure, int, int)
	 * @since 2.1
	 */
	 ...
	 * @see #getPreferredSize(org.eclipse.draw2dl.IFigure, int, int)
	 * @since 2.0
	 */
	 ...
	 * @since 3.3
	 */
	protected Dimension getChildMinimumSize(org.eclipse.draw2dl.IFigure child, int wHint, int hHint) {
	 ...
	 * @since 3.3
	 */
	protected Dimension getChildPreferredSize(org.eclipse.draw2dl.IFigure child, int wHint,
                                              int hHint) {
		return child.getPreferredSize(wHint, hHint);
	}

	/**
	 * Returns {@link org.eclipse.draw2dl.PositionConstants#VERTICAL} by default.
	 * 
