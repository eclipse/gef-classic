 ...
 */
public class LayeredPane extends org.eclipse.draw2dl.Layer {
	 ...
	 * @since 2.0
	 */
	public void add(org.eclipse.draw2dl.IFigure figure, Object layerKey, int index) {
		if (index == -1)
	 ...
	 * @since 2.0
	 */
	public void addLayerAfter(org.eclipse.draw2dl.Layer layer, Object key, Object after) {
	 ...
	 * @since 2.0
	 */
	public void addLayerBefore(org.eclipse.draw2dl.Layer layer, Object key, Object before) {
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.Layer getLayer(Object key) {
		int index = layerKeys.indexOf(key);
		if (index == -1)
			return null;
		return (org.eclipse.draw2dl.Layer) getChildren().get(index);
	}
	 ...
	 * @since 2.0
	 */
	protected org.eclipse.draw2dl.Layer getLayer(int index) {
		return (org.eclipse.draw2dl.Layer) getChildren().get(index);
	}
	 ...
	 * 
	 * @deprecated call {@link org.eclipse.draw2dl.IFigure#remove(org.eclipse.draw2dl.IFigure)} instead
	 * @param layer
