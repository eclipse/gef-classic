...
public class TitleBarBorder extends AbstractLabeledBorder {
	...
	private static Color defaultBackgroundColor = org.eclipse.draw2dl.ColorConstants.menuBackgroundSelected;
	private static Color defaultForegroundColor = ColorConstants.menuForegroundSelected;

	private int textAlignment = org.eclipse.draw2dl.PositionConstants.LEFT;
	 ...
	 * @since 2.0
	 */
	protected Insets calculateInsets(org.eclipse.draw2dl.IFigure figure) {
	 ...
	 * 
	 * @see org.eclipse.draw2dl.AbstractLabeledBorder#getPreferredSize(org.eclipse.draw2dl.IFigure)
	 */
	public Dimension getPreferredSize(org.eclipse.draw2dl.IFigure fig) {
	 ...
	 * {@link org.eclipse.draw2dl.PositionConstants#LEFT}, {@link org.eclipse.draw2dl.PositionConstants#CENTER} and
	 * {@link org.eclipse.draw2dl.PositionConstants#RIGHT}.
	 * 
	 ...
	 * do the same.
	 * 
	 * @see org.eclipse.draw2dl.Border#isOpaque()
	 */
	...
	public void paint(IFigure figure, Graphics g, Insets insets) {
		...
		if (getTextAlignment() == org.eclipse.draw2dl.PositionConstants.CENTER)
			freeSpace /= 2;
		if (getTextAlignment() != org.eclipse.draw2dl.PositionConstants.LEFT)
			x += freeSpace;
