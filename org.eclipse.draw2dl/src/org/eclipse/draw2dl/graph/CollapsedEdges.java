...
class CollapsedEdges {
	...
	int overage;
	int unOverage;
	org.eclipse.draw2dl.graph.Edge tightestEdge;

	CollapsedEdges(org.eclipse.draw2dl.graph.Edge edge) {
		tightestEdge = edge;
	 ...
	 * @since 3.1
	 */
	org.eclipse.draw2dl.graph.Edge processEdge(org.eclipse.draw2dl.graph.Edge candidate) {
		collapsedCount++;
