 ...
 * {@link org.eclipse.draw2dl.graph.Edge}s. A node is given a width and height by the client. When a
...
public class Node {
	 ...
	 */
	public org.eclipse.draw2dl.graph.EdgeList incoming = new org.eclipse.draw2dl.graph.EdgeList();
	 ...
	 */
	public org.eclipse.draw2dl.graph.EdgeList outgoing = new org.eclipse.draw2dl.graph.EdgeList();

	Insets padding;
	private org.eclipse.draw2dl.graph.Subgraph parent;
	int rank;
	 ...
	 *            the parent subgraph
	 */
	public Node(org.eclipse.draw2dl.graph.Subgraph parent) {
		this(null, parent);
	}
	 ...
	 */
	public Node(Object data, org.eclipse.draw2dl.graph.Subgraph parent) {
		this.data = data;
		this.parent = parent;
		if (parent != null)
	 ...
	 */
	public org.eclipse.draw2dl.graph.Subgraph getParent() {
		return parent;
	}
