 ...
 * @since 2.1.2
 */
public class VirtualNode extends org.eclipse.draw2dl.graph.Node {

	/**
	 * The next node.
	 */
	public org.eclipse.draw2dl.graph.Node next;
	 ...
	 *            the row
	 */
	public VirtualNode(org.eclipse.draw2dl.graph.Edge e, int i) {
		super(e);
		incoming.add(e);
		outgoing.add(e);
		width = e.width;
	 ...
	 */
	public int omega() {
		org.eclipse.draw2dl.graph.Edge e = (org.eclipse.draw2dl.graph.Edge) data;
	...
	public String toString() {
		if (data instanceof org.eclipse.draw2dl.graph.Edge)
