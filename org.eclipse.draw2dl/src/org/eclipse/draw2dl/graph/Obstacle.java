...
class Obstacle extends Rectangle {
	...
	boolean exclude;
	org.eclipse.draw2dl.graph.Vertex topLeft, topRight, bottomLeft, bottomRight, center;
	private org.eclipse.draw2dl.graph.ShortestPathRouter router;
	...
	private void growVertex(org.eclipse.draw2dl.graph.Vertex vertex) {
	...
	void init(Rectangle rect) {
		...
		topLeft = new org.eclipse.draw2dl.graph.Vertex(x, y, this);
		topLeft.positionOnObstacle = PositionConstants.NORTH_WEST;
		topRight = new org.eclipse.draw2dl.graph.Vertex(x + width - 1, y, this);
		topRight.positionOnObstacle = PositionConstants.NORTH_EAST;
		bottomLeft = new org.eclipse.draw2dl.graph.Vertex(x, y + height - 1, this);
		bottomLeft.positionOnObstacle = PositionConstants.SOUTH_WEST;
		bottomRight = new org.eclipse.draw2dl.graph.Vertex(x + width - 1, y + height - 1, this);
		bottomRight.positionOnObstacle = PositionConstants.SOUTH_EAST;
		center = new org.eclipse.draw2dl.graph.Vertex(getCenter(), this);
	}
	...
	private void shrinkVertex(org.eclipse.draw2dl.graph.Vertex vertex) {
		if (vertex.totalCount > 0)
			vertex.shrink();
	}
