 ...
 * <LI>All edge's must be added to the graph's {@link org.eclipse.draw2dl.graph.DirectedGraph#edges edges}
 * list exactly once.
 * <LI>All nodes must be added to the graph's {@link org.eclipse.draw2dl.graph.DirectedGraph#nodes nodes}
 * list exactly once.
 * </UL>
 * 
 * This algorithm will:
 ...
 * have the flag {@link org.eclipse.draw2dl.graph.Edge#isFeedback} set to <code>true</code>. The following
 ...
 * {@link org.eclipse.draw2dl.graph.Edge#vNodes virtual} nodes. The virtual nodes
...
public class DirectedGraphLayout {
	...
	void init() {
		steps.add(new org.eclipse.draw2dl.graph.TransposeMetrics());
		steps.add(new org.eclipse.draw2dl.graph.BreakCycles());
		...
		steps.add(new org.eclipse.draw2dl.graph.PopulateRanks());
		steps.add(new org.eclipse.draw2dl.graph.VerticalPlacement());
		steps.add(new org.eclipse.draw2dl.graph.MinCross());
		steps.add(new org.eclipse.draw2dl.graph.LocalOptimizer());
		steps.add(new org.eclipse.draw2dl.graph.HorizontalPlacement());
	}
	...
	public void visit(DirectedGraph graph) {
		...
		for (int i = 0; i < steps.size(); i++) {
			org.eclipse.draw2dl.graph.GraphVisitor visitor = (org.eclipse.draw2dl.graph.GraphVisitor) steps.get(i);
			visitor.visit(graph);
		}
