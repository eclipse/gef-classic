...
public class Path {
	...
	private static class SegmentStack extends ArrayList {
		...
		org.eclipse.draw2dl.graph.Segment pop() {
			return (org.eclipse.draw2dl.graph.Segment) remove(size() - 1);
		}

		org.eclipse.draw2dl.graph.Obstacle popObstacle() {
			return (org.eclipse.draw2dl.graph.Obstacle) remove(size() - 1);
		}
	...
	org.eclipse.draw2dl.graph.Vertex start, end;
	...
	public Path(Point start, Point end) {
		this(new org.eclipse.draw2dl.graph.Vertex(start, null), new org.eclipse.draw2dl.graph.Vertex(end, null));
	}
	 ...
	 *            end vertex
	 */
	Path(org.eclipse.draw2dl.graph.Vertex start, org.eclipse.draw2dl.graph.Vertex end) {
		this();
		this.start = start;
		this.end = end;
	}
	 ...
	 *            the target obstacle
	 */
	private void addAllSegmentsBetween(org.eclipse.draw2dl.graph.Obstacle source, org.eclipse.draw2dl.graph.Obstacle target) {
		addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.bottomLeft, target.bottomLeft),
				source, target, false, false);
		addConnectingSegment(
				new org.eclipse.draw2dl.graph.Segment(source.bottomRight, target.bottomRight), source,
				target, true, true);
		addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.topLeft),
				source, target, true, true);
		addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.topRight, target.topRight),
				source, target, false, false);

		if (source.bottom() == target.bottom()) {
			addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.bottomLeft,
					target.bottomRight), source, target, false, true);
			addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.bottomRight,
					target.bottomLeft), source, target, true, false);
		}
		if (source.y == target.y) {
			addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.topRight),
					source, target, true, false);
			addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.topRight, target.topLeft),
					source, target, false, true);
		}
		if (source.x == target.x) {
			addConnectingSegment(
					new org.eclipse.draw2dl.graph.Segment(source.bottomLeft, target.topLeft), source,
					target, false, true);
			addConnectingSegment(
					new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.bottomLeft), source,
					target, true, false);
		}
		if (source.right() == target.right()) {
			addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.bottomRight,
					target.topRight), source, target, true, false);
			addConnectingSegment(new org.eclipse.draw2dl.graph.Segment(source.topRight,
					target.bottomRight), source, target, false, true);
		}
	}
	 ...
	 *            point
	 */
	private void addConnectingSegment(org.eclipse.draw2dl.graph.Segment segment, org.eclipse.draw2dl.graph.Obstacle o1,
                                      org.eclipse.draw2dl.graph.Obstacle o2, boolean checkTopRight1, boolean checkTopRight2) {
		if (threshold != 0
	 ...
	 */
	private void addObstacle(org.eclipse.draw2dl.graph.Obstacle newObs) {
		visibleObstacles.add(newObs);
		Iterator oItr = new HashSet(visibleObstacles).iterator();
		while (oItr.hasNext()) {
			org.eclipse.draw2dl.graph.Obstacle currObs = (org.eclipse.draw2dl.graph.Obstacle) oItr.next();
			if (newObs != currObs)
	 ...
	 *            the obstacle
	 */
	private void addPerimiterSegments(org.eclipse.draw2dl.graph.Obstacle obs) {
		org.eclipse.draw2dl.graph.Segment seg = new org.eclipse.draw2dl.graph.Segment(obs.topLeft, obs.topRight);
		stack.push(obs);
		stack.push(null);
		stack.push(seg);
		seg = new org.eclipse.draw2dl.graph.Segment(obs.topRight, obs.bottomRight);
		stack.push(obs);
		stack.push(null);
		stack.push(seg);
		seg = new org.eclipse.draw2dl.graph.Segment(obs.bottomRight, obs.bottomLeft);
		stack.push(obs);
		stack.push(null);
		stack.push(seg);
		seg = new org.eclipse.draw2dl.graph.Segment(obs.bottomLeft, obs.topLeft);
		stack.push(obs);
		stack.push(null);
		stack.push(seg);
	}
	 ...
	 */
	private void addSegment(org.eclipse.draw2dl.graph.Segment segment, org.eclipse.draw2dl.graph.Obstacle exclude1,
                            org.eclipse.draw2dl.graph.Obstacle exclude2, List allObstacles) {
		if (threshold != 0
				&& (segment.end.getDistance(end)
						+ segment.end.getDistance(start) > threshold || segment.start
						.getDistance(end) + segment.start.getDistance(start) > threshold))
		...
		for (int i = 0; i < allObstacles.size(); i++) {
			org.eclipse.draw2dl.graph.Obstacle obs = (org.eclipse.draw2dl.graph.Obstacle) allObstacles.get(i);
	 ...
	 *            target obstacle
	 */
	private void addSegmentsFor(org.eclipse.draw2dl.graph.Obstacle source, org.eclipse.draw2dl.graph.Obstacle target) {
	 ...
	 *            target obstacle
	 */
	private void addSegmentsFor(org.eclipse.draw2dl.graph.Vertex vertex, org.eclipse.draw2dl.graph.Obstacle obs) {
		org.eclipse.draw2dl.graph.Segment seg = null;
		org.eclipse.draw2dl.graph.Segment seg2 = null;

		switch (obs.getPosition(vertex)) {
		case PositionConstants.SOUTH_WEST:
		case PositionConstants.NORTH_EAST:
			seg = new org.eclipse.draw2dl.graph.Segment(vertex, obs.topLeft);
			seg2 = new org.eclipse.draw2dl.graph.Segment(vertex, obs.bottomRight);
			break;
		case PositionConstants.SOUTH_EAST:
		case PositionConstants.NORTH_WEST:
			seg = new org.eclipse.draw2dl.graph.Segment(vertex, obs.topRight);
			seg2 = new org.eclipse.draw2dl.graph.Segment(vertex, obs.bottomLeft);
			break;
		case PositionConstants.NORTH:
			seg = new org.eclipse.draw2dl.graph.Segment(vertex, obs.topLeft);
			seg2 = new org.eclipse.draw2dl.graph.Segment(vertex, obs.topRight);
			break;
		case PositionConstants.EAST:
			seg = new org.eclipse.draw2dl.graph.Segment(vertex, obs.bottomRight);
			seg2 = new org.eclipse.draw2dl.graph.Segment(vertex, obs.topRight);
			break;
		...
		default:
			if (vertex.x == obs.x) {
				...
				seg = new org.eclipse.draw2dl.graph.Segment(vertex, obs.bottomLeft);
				seg2 = new org.eclipse.draw2dl.graph.Segment(vertex, obs.bottomRight);
	...
	private void addSegmentsTargetAboveSource(org.eclipse.draw2dl.graph.Obstacle source, org.eclipse.draw2dl.graph.Obstacle target) {
		// target located above source
		org.eclipse.draw2dl.graph.Segment seg = null;
		org.eclipse.draw2dl.graph.Segment seg2 = null;
		if (target.x > source.x) {
			seg = new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.topLeft);
			if (target.x < source.right() - 1)
				seg2 = new org.eclipse.draw2dl.graph.Segment(source.topRight, target.bottomLeft);
			else
				seg2 = new org.eclipse.draw2dl.graph.Segment(source.bottomRight, target.topLeft);
		} else if (source.x == target.x) {
			seg = new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.bottomLeft);
			seg2 = new org.eclipse.draw2dl.graph.Segment(source.topRight, target.bottomLeft);
		} else {
			seg = new org.eclipse.draw2dl.graph.Segment(source.bottomLeft, target.bottomLeft);
			seg2 = new org.eclipse.draw2dl.graph.Segment(source.topRight, target.bottomLeft);
		}
		...
		if (target.right() < source.right()) {
			seg = new org.eclipse.draw2dl.graph.Segment(source.topRight, target.topRight);
			if (target.right() - 1 > source.x)
				seg2 = new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.bottomRight);
			else
				seg2 = new org.eclipse.draw2dl.graph.Segment(source.bottomLeft, target.topRight);
		} else if (source.right() == target.right()) {
			seg = new org.eclipse.draw2dl.graph.Segment(source.topRight, target.bottomRight);
			seg2 = new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.bottomRight);
		} else {
			seg = new org.eclipse.draw2dl.graph.Segment(source.bottomRight, target.bottomRight);
			seg2 = new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.bottomRight);
		}
	...
	private void addSegmentsTargetBesideSource(org.eclipse.draw2dl.graph.Obstacle source, org.eclipse.draw2dl.graph.Obstacle target) {
		// target located above source
		org.eclipse.draw2dl.graph.Segment seg = null;
		org.eclipse.draw2dl.graph.Segment seg2 = null;
		if (target.y > source.y) {
			...
			// degenerate case
			seg = new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.topRight);
			seg2 = new org.eclipse.draw2dl.graph.Segment(source.bottomLeft, target.topRight);
		} else {
			seg = new org.eclipse.draw2dl.graph.Segment(source.topRight, target.topRight);
			seg2 = new org.eclipse.draw2dl.graph.Segment(source.bottomLeft, target.topRight);
		...
		if (target.bottom() < source.bottom()) {
			...
			seg = new org.eclipse.draw2dl.graph.Segment(source.bottomLeft, target.bottomRight);
			seg2 = new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.bottomRight);
		} else {
			seg = new org.eclipse.draw2dl.graph.Segment(source.bottomRight, target.bottomRight);
			seg2 = new org.eclipse.draw2dl.graph.Segment(source.topLeft, target.bottomRight);
 ...
 */
	...
	private void createVisibilityGraph(List allObstacles) {
		stack.push(null);
		stack.push(null);
		stack.push(new org.eclipse.draw2dl.graph.Segment(start, end));
	...
	private boolean determineShortestPath() {
		if (!labelGraph())
			return false;
		org.eclipse.draw2dl.graph.Vertex vertex = end;
		prevCostRatio = end.cost / start.getDistance(end);

		org.eclipse.draw2dl.graph.Vertex nextVertex;
		while (!vertex.equals(start)) {
			nextVertex = vertex.label;
			if (nextVertex == null)
				return false;
			org.eclipse.draw2dl.graph.Segment s = new org.eclipse.draw2dl.graph.Segment(nextVertex, vertex);
			segments.add(s);
			vertex = nextVertex;
		}
	 ...
	 * @return the new path
	 */
	Path getSubPath(org.eclipse.draw2dl.graph.Segment currentSegment) {
		// ready new path
	 ...
	 */
	void invertPriorVertices(org.eclipse.draw2dl.graph.Segment currentSegment) {
		int stop = grownSegments.indexOf(currentSegment);
		for (int i = 0; i < stop; i++) {
			org.eclipse.draw2dl.graph.Vertex vertex = ((org.eclipse.draw2dl.graph.Segment) grownSegments.get(i)).end;
			if (vertex.type == org.eclipse.draw2dl.graph.Vertex.INNIE)
				vertex.type = org.eclipse.draw2dl.graph.Vertex.OUTIE;
			else
				vertex.type = org.eclipse.draw2dl.graph.Vertex.INNIE;
		}
	}
	 ...
	 */
	boolean isObstacleVisible(org.eclipse.draw2dl.graph.Obstacle obs) {
	...
	private boolean labelGraph() {
		...
		org.eclipse.draw2dl.graph.Vertex vertex = start;
		org.eclipse.draw2dl.graph.Vertex neighborVertex = null;
		...
		while (numPermanentNodes != visibleVertices.size()) {
			...
			for (int i = 0; i < neighbors.size(); i++) {
				neighborVertex = (org.eclipse.draw2dl.graph.Vertex) neighbors.get(i);
			...
			org.eclipse.draw2dl.graph.Vertex tempVertex = null;
			Iterator v = visibleVertices.iterator();
			while (v.hasNext()) {
				tempVertex = (org.eclipse.draw2dl.graph.Vertex) v.next();
	 ...
	 *            the segment to add
	 */
	private void linkVertices(org.eclipse.draw2dl.graph.Segment segment) {
	...
	void reconnectSubPaths() {
		if (subPath != null) {
			...
			org.eclipse.draw2dl.graph.Segment changedSegment = (org.eclipse.draw2dl.graph.Segment) subPath.grownSegments.remove(0);
			org.eclipse.draw2dl.graph.Segment oldSegment = (org.eclipse.draw2dl.graph.Segment) grownSegments.get(grownSegments
					.size() - 1);
	...
	void refreshExcludedObstacles(List allObstacles) {
		...
		for (int i = 0; i < allObstacles.size(); i++) {
			org.eclipse.draw2dl.graph.Obstacle o = (org.eclipse.draw2dl.graph.Obstacle) allObstacles.get(i);
			o.exclude = false;
	...
	public void setEndPoint(Point end) {
		if (end.equals(this.end))
			return;
		this.end = new org.eclipse.draw2dl.graph.Vertex(end, null);
		isDirty = true;
	}
	...
	public void setStartPoint(Point start) {
		if (start.equals(this.start))
			return;
		this.start = new org.eclipse.draw2dl.graph.Vertex(start, null);
		isDirty = true;
	}
	 ...
	 */
	boolean testAndSet(org.eclipse.draw2dl.graph.Obstacle obs) {
		if (isDirty)
			return false;
		...
		org.eclipse.draw2dl.graph.Segment seg1 = new org.eclipse.draw2dl.graph.Segment(obs.topLeft, obs.bottomRight);
		org.eclipse.draw2dl.graph.Segment seg2 = new org.eclipse.draw2dl.graph.Segment(obs.topRight, obs.bottomLeft);
