 ...
 * @since 2.1.2
 */
public class Subgraph extends org.eclipse.draw2dl.graph.Node {

	/**
	 * The children of this subgraph. Nodes may not belong to more than one
	 * subgraph.
	 */
	public org.eclipse.draw2dl.graph.NodeList members = new NodeList();

	org.eclipse.draw2dl.graph.Node head;
	org.eclipse.draw2dl.graph.Node tail;
	org.eclipse.draw2dl.graph.Node left;
	org.eclipse.draw2dl.graph.Node right;
	int nestingTreeMin;
	 ...
	 * 
	 * @see org.eclipse.draw2dl.graph.Node#Node(Object)
	 * @param data
	 ...
	 * 
	 * @see org.eclipse.draw2dl.graph.Node#Node(Object, Subgraph)
	 * @param data
	 *            an arbitrary data object
	 * @param parent
	 *            the parent
	 ...
	 *            the node to add
	 */
	public void addMember(org.eclipse.draw2dl.graph.Node n) {
		members.add(n);
	}
