...
public class Edge {
	 ...
	 * {@link org.eclipse.draw2dl.graph.Node#getOffsetOutgoing() outgoing} attachment point.
	 * 
	 * @deprecated use accessors instead
	 */
	 ...
	 * value is -1, which indicates that the edge should use the node's default
	 * {@link org.eclipse.draw2dl.graph.Node#getOffsetIncoming() incoming} attachment point.
	 * 
	 * @deprecated use accessors instead
	 */
	 ...
	 * The source Node.
	 */
	public org.eclipse.draw2dl.graph.Node source;
	/**
	 * The starting point.
	 * 
	 * @deprecated use {@link #getPoints()}
	 ...
	 * The target Node.
	 */
	public org.eclipse.draw2dl.graph.Node target;
	 ...
	 */
	public org.eclipse.draw2dl.graph.NodeList vNodes;
	/**
	 ...
	 *            the target Node
	 */
	public Edge(org.eclipse.draw2dl.graph.Node source, org.eclipse.draw2dl.graph.Node target) {
	 ...
	 *            the weight hint
	 */
	public Edge(org.eclipse.draw2dl.graph.Node source, org.eclipse.draw2dl.graph.Node target, int delta, int weight) {
		this(source, target);
		this.delta = delta;
		this.weight = weight;
	}
	 ...
	 *            the target node
	 */
	public Edge(Object data, org.eclipse.draw2dl.graph.Node source, org.eclipse.draw2dl.graph.Node target) {
		this.data = data;
		this.source = source;
		this.target = target;
	...
	/**
	 * For internal use only. Returns the index of the {@link org.eclipse.draw2dl.graph.Node} (or
	...
	public void invert() {
		...
		org.eclipse.draw2dl.graph.Node oldTarget = target;
		target = source;
		source = oldTarget;
		...
		if (vNodes != null) {
			org.eclipse.draw2dl.graph.NodeList newVNodes = new NodeList();
	 ...
	 */
	public org.eclipse.draw2dl.graph.Node opposite(org.eclipse.draw2dl.graph.Node end) {
		if (source == end)
			return target;
		return source;
	}
	 ...
	 * @since 3.2
	 */
	public void setSource(org.eclipse.draw2dl.graph.Node node) {
		if (source == node)
			return;
		if (source != null)
			source.outgoing.remove(this);
