...
public class DirectedGraph {
	 ...
	 */
	public org.eclipse.draw2dl.graph.EdgeList edges = new EdgeList();

	/**
	 * All of the nodes in the graph.
	 */
	public org.eclipse.draw2dl.graph.NodeList nodes = new NodeList();
	 ...
	 * @deprecated
	 */
	public org.eclipse.draw2dl.graph.RankList ranks = new RankList();

	org.eclipse.draw2dl.graph.Node forestRoot;
	 ...
	 */
	public Insets getPadding(org.eclipse.draw2dl.graph.Node node) {
	...
	public org.eclipse.draw2dl.graph.Node getNode(int rank, int index) {
		if (ranks.size() <= rank)
			return null;
