 ...
 * <p>
 * Note: When a Canvas with a {@link org.eclipse.draw2dl.LightweightSystem} gains focus, it gives
...
public class FocusTraverseManager {
	...
	org.eclipse.draw2dl.IFigure currentFocusOwner;
	 ...
	 * 
	 * @param root
	 *            the {@link org.eclipse.draw2dl.LightweightSystem LightweightSystem's} root figure
	 * @param prevFocus
	 *            the IFigure who currently owns focus
	 * @return the next focusable figure
	 */
	public org.eclipse.draw2dl.IFigure getNextFocusableFigure(org.eclipse.draw2dl.IFigure root, org.eclipse.draw2dl.IFigure prevFocus) {
		boolean found = false;
		org.eclipse.draw2dl.IFigure nextFocus = prevFocus;
		...
		while (!found) {
			org.eclipse.draw2dl.IFigure parent = nextFocus.getParent();
			...
			if (nextFocus.getChildren().size() != 0) {
				...
				while (!untraversedSiblingFound) {
					org.eclipse.draw2dl.IFigure p = nextFocus.getParent();
					org.eclipse.draw2dl.IFigure gp = p.getParent();
	 ...
	 */
	public org.eclipse.draw2dl.IFigure getPreviousFocusableFigure(org.eclipse.draw2dl.IFigure root, org.eclipse.draw2dl.IFigure prevFocus) {
		if (prevFocus == null)
			return null;
	 ...
	 */
	public org.eclipse.draw2dl.IFigure getCurrentFocusOwner() {
		return currentFocusOwner;
	}

	private boolean isFocusEligible(org.eclipse.draw2dl.IFigure fig) {
