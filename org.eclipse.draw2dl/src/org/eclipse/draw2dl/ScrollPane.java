...
public class ScrollPane extends Figure {
	...
	protected org.eclipse.draw2dl.Viewport viewport;
	/** The horizontal scrollbar */
	protected org.eclipse.draw2dl.ScrollBar hBar;
	/** The vertical scrollbar */
	protected org.eclipse.draw2dl.ScrollBar vBar;
	...
	protected void createHorizontalScrollBar() {
		org.eclipse.draw2dl.ScrollBar bar = new org.eclipse.draw2dl.ScrollBar();
	...
	protected void createViewport() {
		setViewport(new org.eclipse.draw2dl.Viewport());
	}
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.ScrollBar getHorizontalScrollBar() {
		if (hBar == null)
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.ScrollBar getVerticalScrollBar() {
		if (vBar == null)
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.IFigure getView() {
		return getViewport().getContents();
	}

	/**
	 * Returns the ScrollPane's {@link org.eclipse.draw2dl.Viewport}.
	 * 
	 * @return the viewport
	 * @since 2.0
	 */
	 ...
	 * @since 2.0
	 */
	public void setHorizontalScrollBar(org.eclipse.draw2dl.ScrollBar bar) {
		if (hBar != null) {
			remove(hBar);
	 ...
	 * @since 2.0
	 */
	public void setView(org.eclipse.draw2dl.IFigure figure) {
