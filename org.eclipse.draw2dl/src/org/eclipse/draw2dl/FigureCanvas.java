 ...
 * {@link org.eclipse.draw2dl.Viewport}. Call {@link #setContents(org.eclipse.draw2dl.IFigure)} to specify the root of
 ...
 * <li>Create a Draw2d Figure and call {@link #setContents(org.eclipse.draw2dl.IFigure)}. This
...
public class FigureCanvas extends Canvas {
	...
	private org.eclipse.draw2dl.Viewport viewport;
	private Font font;
	...
	private PropertyChangeListener horizontalChangeListener = new PropertyChangeListener() {
		public void propertyChange(PropertyChangeEvent event) {
			org.eclipse.draw2dl.RangeModel model = getViewport().getHorizontalRangeModel();
	...
	private PropertyChangeListener verticalChangeListener = new PropertyChangeListener() {
		public void propertyChange(PropertyChangeEvent event) {
			org.eclipse.draw2dl.RangeModel model = getViewport().getVerticalRangeModel();
	...
	private final org.eclipse.draw2dl.LightweightSystem lws;
	...
	public FigureCanvas(Composite parent) {
		this(parent, SWT.DOUBLE_BUFFERED, new org.eclipse.draw2dl.LightweightSystem());
	}
	...
	public FigureCanvas(Composite parent, int style) {
		this(parent, style, new org.eclipse.draw2dl.LightweightSystem());
	}
	...
	public FigureCanvas(int style, Composite parent) {
		this(style, parent, new org.eclipse.draw2dl.LightweightSystem());
	}
	 ...
	 */
	public FigureCanvas(Composite parent, org.eclipse.draw2dl.LightweightSystem lws) {
	 ...
	 * @since 3.4
	 */
	public FigureCanvas(int style, Composite parent, org.eclipse.draw2dl.LightweightSystem lws) {
	 ...
	 * @since 3.1
	 */
	public FigureCanvas(Composite parent, int style, org.eclipse.draw2dl.LightweightSystem lws) {
	...
	/**
	 * @return the contents of the {@link org.eclipse.draw2dl.Viewport}.
	 */
	public org.eclipse.draw2dl.IFigure getContents() {
	 ...
	 * @return the viewport
	 */
	public org.eclipse.draw2dl.Viewport getViewport() {
		if (viewport == null)
			setViewport(new org.eclipse.draw2dl.Viewport(true));
		return viewport;
	}
	...
	private void layoutViewport() {
		org.eclipse.draw2dl.ScrollPaneSolver.Result result;
	...
	/**
	 * Sets the contents of the {@link org.eclipse.draw2dl.Viewport}.
	 * 
	 * @param figure
	 *            the new contents
	 */
