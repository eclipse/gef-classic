 ...
 * model and updates the model accordingly. {@link org.eclipse.draw2dl.ButtonModel} is used by
 * default. Any figure can be set as contents to a Clickable.
 * Clickable->EventHandler->Model->ModelObserver->Listeners of actions.
 */
public class Clickable extends org.eclipse.draw2dl.Figure {

	private static final int ROLLOVER_ENABLED_FLAG = org.eclipse.draw2dl.Figure.MAX_FLAG << 1,
			STYLE_BUTTON_FLAG = org.eclipse.draw2dl.Figure.MAX_FLAG << 2,
	 ...
	 * 
	 * @see org.eclipse.draw2dl.ActionListener
	 * @see org.eclipse.draw2dl.ChangeListener
	 */
	static interface ModelObserver extends org.eclipse.draw2dl.ActionListener, org.eclipse.draw2dl.ChangeListener {
	}

	private org.eclipse.draw2dl.ClickableEventHandler eventHandler;

	private org.eclipse.draw2dl.ButtonModel model;
	 ...
	 *            The content figure
	 */
	public Clickable(org.eclipse.draw2dl.IFigure contents) {
		this(contents, 0);
	}
	 ...
	 *            The button style
	 */
	public Clickable(org.eclipse.draw2dl.IFigure contents, int style) {
	 ...
	 * @since 2.0
	 */
	public void addActionListener(org.eclipse.draw2dl.ActionListener listener) {
		addListener(org.eclipse.draw2dl.ActionListener.class, listener);
	}
	 ...
	 * @since 2.0
	 */
	public void addChangeListener(org.eclipse.draw2dl.ChangeListener listener) {
		addListener(org.eclipse.draw2dl.ChangeListener.class, listener);
	}
	 ...
	 * @since 2.0
	 */
	protected org.eclipse.draw2dl.ButtonModel createDefaultModel() {
		if (isStyle(STYLE_TOGGLE))
			return new ToggleModel();
		else
			return new org.eclipse.draw2dl.ButtonModel();
	}
	 ...
	 * @since 2.0
	 */
	protected org.eclipse.draw2dl.ClickableEventHandler createEventHandler() {
		return new org.eclipse.draw2dl.ClickableEventHandler();
	}
	...
	protected ModelObserver createModelObserver() {
		return new ModelObserver() {
			public void actionPerformed(org.eclipse.draw2dl.ActionEvent action) {
				fireActionPerformed();
			}

			public void handleStateChanged(org.eclipse.draw2dl.ChangeEvent change) {
	...
	protected void fireActionPerformed() {
		org.eclipse.draw2dl.ActionEvent action = new ActionEvent(this);
		Iterator listeners = getListeners(org.eclipse.draw2dl.ActionListener.class);
		while (listeners.hasNext())
			((org.eclipse.draw2dl.ActionListener) listeners.next()) // Leave newline for debug
												// stepping
	 ...
	 * @since 2.0
	 */
	protected void fireStateChanged(org.eclipse.draw2dl.ChangeEvent modelChange) {
		org.eclipse.draw2dl.ChangeEvent change = new ChangeEvent(this,
				modelChange.getPropertyName());
		Iterator listeners = getListeners(org.eclipse.draw2dl.ChangeListener.class);
		while (listeners.hasNext())
			((org.eclipse.draw2dl.ChangeListener) listeners.next()) // Leave newline for debug
												// stepping
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.ButtonModel getModel() {
		return model;
	}
	 ...
	 * @since 2.0
	 */
	protected void hookEventHandler(org.eclipse.draw2dl.ClickableEventHandler handler) {
		if (handler == null)
			return;
	 ...
	 * @since 2.0
	 */
	public void removeActionListener(org.eclipse.draw2dl.ActionListener listener) {
	 ...
	 * @since 2.0
	 */
	public void removeChangeListener(org.eclipse.draw2dl.ChangeListener listener) {
	 ...
	 * @since 2.0
	 */
	public void setEventHandler(org.eclipse.draw2dl.ClickableEventHandler h) {
	...
	public void setStyle(int style) {
		if ((style & STYLE_BUTTON) != 0) {
			...
			if (!(getBorder() instanceof org.eclipse.draw2dl.ButtonBorder))
	 ...
	 * @since 2.0
	 */
	protected void unhookEventHandler(org.eclipse.draw2dl.ClickableEventHandler handler) {
		if (handler == null)
			return;
