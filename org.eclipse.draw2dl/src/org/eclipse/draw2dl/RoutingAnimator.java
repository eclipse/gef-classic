 ...
 * {@link PolylineConnection#addRoutingListener(org.eclipse.draw2dl.RoutingListener)}. An animator
 * is active only when the Animation utility is activated.
 * 
 * @since 3.2
 */
public class RoutingAnimator extends org.eclipse.draw2dl.Animator implements org.eclipse.draw2dl.RoutingListener {
	 ...
	 * 
	 * @see org.eclipse.draw2dl.Animator#playbackStarting(org.eclipse.draw2dl.IFigure)
	 */
	public void playbackStarting(org.eclipse.draw2dl.IFigure connection) {
		reconcileStates((org.eclipse.draw2dl.Connection) connection);
	}
	 ...
	 * 
	 * @see org.eclipse.draw2dl.Animator#getCurrentState(org.eclipse.draw2dl.IFigure)
	 */
	protected Object getCurrentState(org.eclipse.draw2dl.IFigure connection) {
		return ((org.eclipse.draw2dl.Connection) connection).getPoints().getCopy();
	}
	 ...
	 * 
	 * @see org.eclipse.draw2dl.RoutingListener#invalidate(org.eclipse.draw2dl.Connection)
	 */
	public final void invalidate(org.eclipse.draw2dl.Connection conn) {
		if (org.eclipse.draw2dl.Animation.isInitialRecording())
			org.eclipse.draw2dl.Animation.hookAnimator(conn, this);
	}
	...
	protected boolean playback(IFigure figure) {
		org.eclipse.draw2dl.Connection conn = (org.eclipse.draw2dl.Connection) figure;

		PointList list1 = (PointList) org.eclipse.draw2dl.Animation.getInitialState(this, conn);
		PointList list2 = (PointList) org.eclipse.draw2dl.Animation.getFinalState(this, conn);
		if (list1 == null) {
	 ...
	 * 
	 * @see org.eclipse.draw2dl.RoutingListener#postRoute(org.eclipse.draw2dl.Connection)
	 */
	public final void postRoute(org.eclipse.draw2dl.Connection connection) {
		if (org.eclipse.draw2dl.Animation.isFinalRecording())
			org.eclipse.draw2dl.Animation.hookNeedsCapture(connection, this);
	}

	private void reconcileStates(org.eclipse.draw2dl.Connection conn) {
		PointList points1 = (PointList) org.eclipse.draw2dl.Animation.getInitialState(this, conn);
		PointList points2 = (PointList) org.eclipse.draw2dl.Animation.getFinalState(this, conn);
	 ...
	 * 
	 * @see org.eclipse.draw2dl.RoutingListener#remove(org.eclipse.draw2dl.Connection)
	 */
	public final void remove(org.eclipse.draw2dl.Connection connection) {
	}

	/**
	 * Hooks route to intercept routing during animation playback.
	 * 
	 * @see org.eclipse.draw2dl.RoutingListener#route(org.eclipse.draw2dl.Connection)
	 */
	public final boolean route(org.eclipse.draw2dl.Connection conn) {
		return org.eclipse.draw2dl.Animation.isAnimating() && Animation.hookPlayback(conn, this);
	}

	/**
	 * This callback is unused. Reserved for possible future use.
	 * 
	 * @see RoutingListener#setConstraint(org.eclipse.draw2dl.Connection, Object)
	 */
