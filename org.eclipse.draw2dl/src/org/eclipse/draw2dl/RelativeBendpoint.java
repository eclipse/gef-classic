 ...
 * distance from the start and end points of the {@link org.eclipse.draw2dl.Connection}, as well as
...
public class RelativeBendpoint implements Bendpoint {
	 ...
	 * @since 2.0
	 */
	public RelativeBendpoint(org.eclipse.draw2dl.Connection conn) {
		setConnection(conn);
	}
