...
public class FigureUtilities {
	 ...
	 */
	public static org.eclipse.draw2dl.IFigure getRoot(org.eclipse.draw2dl.IFigure figure) {
	 ...
	 * @since 2.0
	 */
	public static org.eclipse.draw2dl.Shape makeGhostShape(Shape s) {
	 ...
	 * @since 2.0
	 */
	public static void paintEtchedBorder(org.eclipse.draw2dl.Graphics g, Rectangle r, Color shadow,
                                         Color highlight) {
		int x = r.x, y = r.y, w = r.width, h = r.height;

		g.setLineStyle(org.eclipse.draw2dl.Graphics.LINE_SOLID);
		g.setLineWidth(1);
		g.setXORMode(false);
	 ...
	 * @since 3.0
	 */
	public static void paintGrid(org.eclipse.draw2dl.Graphics g, org.eclipse.draw2dl.IFigure f,
                                 Point origin, int distanceX,
                                 int distanceY) {
	 ...
	 */
	public static org.eclipse.draw2dl.IFigure findCommonAncestor(org.eclipse.draw2dl.IFigure l, org.eclipse.draw2dl.IFigure r) {
		if (l == r)
			return l;
		...
		for (int i = 0; i < left.size(); i++) {
			if (right.contains(left.get(i)))
				return (org.eclipse.draw2dl.IFigure) left.get(i);
		}
		return null;
	}
	 ...
	 * @since 3.2
	 */
	public static boolean isAncestor(final org.eclipse.draw2dl.IFigure ancestor, org.eclipse.draw2dl.IFigure descendant) {
	 ...
	 * @since 3.7
	 */
	public static boolean isNotFullyClipped(org.eclipse.draw2dl.IFigure figure) {
