...
public class ButtonModel {
	 ...
	 */
	protected org.eclipse.draw2dl.ButtonGroup group = null;

	private org.eclipse.draw2dl.EventListenerList listeners = new EventListenerList();
	 ...
	 */
	protected org.eclipse.draw2dl.ButtonStateTransitionListener firingBehavior;
	{
	...
	public void addActionListener(org.eclipse.draw2dl.ActionListener listener) {
		...
		listeners.addListener(org.eclipse.draw2dl.ActionListener.class, listener);
	}
	...
	public void addChangeListener(org.eclipse.draw2dl.ChangeListener listener) {
		if (listener == null)
			throw new IllegalArgumentException();
		listeners.addListener(org.eclipse.draw2dl.ChangeListener.class, listener);
	}
	...
	public void addStateTransitionListener(
			org.eclipse.draw2dl.ButtonStateTransitionListener listener) {
		if (listener == null)
			throw new IllegalArgumentException();
		listeners.addListener(org.eclipse.draw2dl.ButtonStateTransitionListener.class, listener);
	}
	...
	protected void fireActionPerformed() {
		Iterator iter = listeners.getListeners(org.eclipse.draw2dl.ActionListener.class);
		org.eclipse.draw2dl.ActionEvent action = new ActionEvent(this);
		while (iter.hasNext())
			((org.eclipse.draw2dl.ActionListener) iter.next()).actionPerformed(action);
	}
	...
	protected void fireCanceled() {
		Iterator iter = listeners
				.getListeners(org.eclipse.draw2dl.ButtonStateTransitionListener.class);
		while (iter.hasNext())
			((org.eclipse.draw2dl.ButtonStateTransitionListener) iter.next()).canceled();
	}
	...
	protected void firePressed() {
		Iterator iter = listeners
				.getListeners(org.eclipse.draw2dl.ButtonStateTransitionListener.class);
		while (iter.hasNext())
			((org.eclipse.draw2dl.ButtonStateTransitionListener) iter.next()).pressed();
	}
	...
	protected void fireReleased() {
		Iterator iter = listeners
				.getListeners(org.eclipse.draw2dl.ButtonStateTransitionListener.class);
		while (iter.hasNext())
			((org.eclipse.draw2dl.ButtonStateTransitionListener) iter.next()).released();
	}
	...
	protected void fireResume() {
		Iterator iter = listeners
				.getListeners(org.eclipse.draw2dl.ButtonStateTransitionListener.class);
		while (iter.hasNext())
			((org.eclipse.draw2dl.ButtonStateTransitionListener) iter.next()).resume();
	}
	...
	protected void fireStateChanged(String property) {
		Iterator iter = listeners.getListeners(org.eclipse.draw2dl.ChangeListener.class);
		org.eclipse.draw2dl.ChangeEvent change = new ChangeEvent(this, property);
		while (iter.hasNext())
			((org.eclipse.draw2dl.ChangeListener) iter.next()).handleStateChanged(change);
	}
	...
	protected void fireSuspend() {
		Iterator iter = listeners
				.getListeners(org.eclipse.draw2dl.ButtonStateTransitionListener.class);
		while (iter.hasNext())
			((org.eclipse.draw2dl.ButtonStateTransitionListener) iter.next()).suspend();
	}
	 ...
	 * @since 2.0
	 */
	public org.eclipse.draw2dl.ButtonGroup getGroup() {
		return group;
	}
	...
	public void removeStateTransitionListener(
			org.eclipse.draw2dl.ButtonStateTransitionListener listener) {
		listeners.removeListener(org.eclipse.draw2dl.ButtonStateTransitionListener.class, listener);
	}
	...
	class DefaultFiringBehavior extends org.eclipse.draw2dl.ButtonStateTransitionListener {
		public void released() {
			fireActionPerformed();
		}
	}

	class RepeatFiringBehavior extends org.eclipse.draw2dl.ButtonStateTransitionListener {
