 ...
 * <P>
 * Instances can be hooked to a {@link org.eclipse.draw2dl.PolylineConnection} by calling
...
public interface RoutingListener {
	 ...
	 * @since 3.2
	 */
	void postRoute(org.eclipse.draw2dl.Connection connection);
	 ...
	 * @since 3.2
	 */
	boolean route(org.eclipse.draw2dl.Connection connection);
	...
	class Stub implements RoutingListener {
		...
		public void postRoute(org.eclipse.draw2dl.Connection connection) {
		}

		public void remove(org.eclipse.draw2dl.Connection connection) {
		}

		public boolean route(org.eclipse.draw2dl.Connection connection) {
			return false;
		}
