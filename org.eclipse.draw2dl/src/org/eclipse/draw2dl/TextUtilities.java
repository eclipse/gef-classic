...
public class TextUtilities {
	...
	public Dimension getStringExtents(String s, Font f) {
		return org.eclipse.draw2dl.FigureUtilities.getStringExtents(s, f);
	}
	...
	public Dimension getTextExtents(String s, Font f) {
		return org.eclipse.draw2dl.FigureUtilities.getTextExtents(s, f);
	}
	...
	public int getAscent(Font font) {
		FontMetrics fm = org.eclipse.draw2dl.FigureUtilities.getFontMetrics(font);
	...
	public int getDescent(Font font) {
		return org.eclipse.draw2dl.FigureUtilities.getFontMetrics(font).getDescent();
	}
