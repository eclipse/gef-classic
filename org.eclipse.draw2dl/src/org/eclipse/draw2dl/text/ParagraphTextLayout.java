...
/**
 * The layout for {@link org.eclipse.draw2dl.text.TextFlow}.
 * 
 * @author hudsonr
 * @since 2.1
 */
public class ParagraphTextLayout extends TextLayout {
	 ...
	 *            the TextFlow
	 */
	public ParagraphTextLayout(org.eclipse.draw2dl.text.TextFlow flow) {
		super(flow);
	}
	 ...
	 */
	public ParagraphTextLayout(org.eclipse.draw2dl.text.TextFlow flow, int style) {
		this(flow);
		wrappingStyle = style;
	}
	...
	class SegmentLookahead implements org.eclipse.draw2dl.text.FlowUtilities.LookAhead {
		private int seg = -1;
		private String segs[];
		private int[] width;
		...
		public int getWidth() {
			if (width == null) {
				...
				org.eclipse.draw2dl.text.TextFlow textFlow = (org.eclipse.draw2dl.text.TextFlow) getFlowFigure();
	...
	protected void layout() {
		org.eclipse.draw2dl.text.TextFlow textFlow = (TextFlow) getFlowFigure();
		int offset = 0;
		...
		org.eclipse.draw2dl.text.FlowBorder border = null;
		if (textFlow.getBorder() instanceof org.eclipse.draw2dl.text.FlowBorder)
