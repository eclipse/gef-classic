...
public class NestedLine extends LineBox {
	...
	org.eclipse.draw2dl.text.InlineFlow owner;
	private org.eclipse.draw2dl.text.LineRoot root;
	...
	int getAscentWithBorder() {
		return contentAscent + org.eclipse.draw2dl.text.FlowUtilities.getBorderAscent(owner);
	}

	int getDescentWithBorder() {
		return contentDescent + org.eclipse.draw2dl.text.FlowUtilities.getBorderDescent(owner);
	}
	...
	org.eclipse.draw2dl.text.LineRoot getLineRoot() {
		return root;
	}
	...
	public int getOuterAscent() {
		return contentAscent + org.eclipse.draw2dl.text.FlowUtilities.getBorderAscentWithMargin(owner);
	}
