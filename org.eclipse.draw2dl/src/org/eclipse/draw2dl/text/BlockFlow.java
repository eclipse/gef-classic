...
/**
 * A <code>FlowFigure</code> represented by a single {@link org.eclipse.draw2dl.text.BlockBox} containing
 ...
 * <P>
 * Only {@link org.eclipse.draw2dl.text.FlowFigure}s can be added to a BlockFlow.
 * <P>
 ...
 * @since 2.1
 */
public class BlockFlow extends org.eclipse.draw2dl.text.FlowFigure {

	private final org.eclipse.draw2dl.text.BlockBox blockBox;
	 ...
	 * 
	 * @see org.eclipse.draw2dl.text.FlowFigure#contributeBidi(org.eclipse.draw2dl.text.BidiProcessor)
	 */
	protected void contributeBidi(org.eclipse.draw2dl.text.BidiProcessor proc) {
		proc.addControlChar(org.eclipse.draw2dl.text.BidiChars.P_SEP);
	}

	org.eclipse.draw2dl.text.BlockBox createBlockBox() {
		return new org.eclipse.draw2dl.text.BlockBox(this);
	}

	/**
	 * @see org.eclipse.draw2dl.text.FlowFigure#createDefaultFlowLayout()
	 */
	protected FlowFigureLayout createDefaultFlowLayout() {
		return new org.eclipse.draw2dl.text.BlockFlowLayout(this);
	}
	...
	int getLeftMargin() {
		if (getBorder() instanceof org.eclipse.draw2dl.text.FlowBorder)
			return ((org.eclipse.draw2dl.text.FlowBorder) getBorder()).getLeftMargin();
		return 0;
	}
	...
	int getRightMargin() {
		if (getBorder() instanceof org.eclipse.draw2dl.text.FlowBorder)
			return ((org.eclipse.draw2dl.text.FlowBorder) getBorder()).getRightMargin();
		return 0;
	}
	...
	/**
	 * @see org.eclipse.draw2dl.text.FlowFigure#postValidate()
	 */
	...
	public void revalidate() {
		org.eclipse.draw2dl.text.BlockFlowLayout layout = (BlockFlowLayout) getLayoutManager();
	 ...
	 * 
	 * @see org.eclipse.draw2dl.text.FlowFigure#revalidateBidi(IFigure)
	 */
	...
	public void validate() {
		if (!bidiValid) {
			org.eclipse.draw2dl.text.BidiProcessor.INSTANCE.setOrientation(getOrientation());
			if (getOrientation() == SWT.LEFT_TO_RIGHT && isMirrored())
				org.eclipse.draw2dl.text.BidiProcessor.INSTANCE.addControlChar(org.eclipse.draw2dl.text.BidiChars.LRE);
			super.contributeBidi(org.eclipse.draw2dl.text.BidiProcessor.INSTANCE);
