...
public final class BidiProcessor {
	...
	private static class BidiEntry {
		int begin, end;
		org.eclipse.draw2dl.text.FlowFigure fig;

		BidiEntry(org.eclipse.draw2dl.text.FlowFigure fig, int offset, int length) {
			this.fig = fig;
			this.begin = offset;
	 ...
	 */
	public void add(org.eclipse.draw2dl.text.FlowFigure fig, String str) {
	...
	private void assignResults(int[] levels) {
		...
		org.eclipse.draw2dl.text.BidiInfo prevInfo = null, info = null;
		int end = 2, start = 0;
	...
	private boolean isJoiningCharacter(char c) {
		return Character.getDirectionality(c) == Character.DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC
				|| c == org.eclipse.draw2dl.text.BidiChars.ZWJ;
	}
