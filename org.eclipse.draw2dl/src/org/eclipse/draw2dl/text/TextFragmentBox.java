...
public class TextFragmentBox extends ContentBox {
	...
	private org.eclipse.draw2dl.text.TextFlow textflow;
	...
	int getAscentWithBorder() {
		return textflow.getAscent() + org.eclipse.draw2dl.text.FlowUtilities.getBorderAscent(textflow);
	}
	...
	int getDescentWithBorder() {
		return textflow.getDescent() + org.eclipse.draw2dl.text.FlowUtilities.getBorderDescent(textflow);
	}

	int getOuterAscent() {
		return textflow.getAscent()
				+ org.eclipse.draw2dl.text.FlowUtilities.getBorderAscentWithMargin(textflow);
	}
