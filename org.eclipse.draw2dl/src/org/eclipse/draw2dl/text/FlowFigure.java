...
public abstract class FlowFigure extends Figure {
	...
	public void add(IFigure child, Object constraint, int index) {
		...
		// FlowFigure
		if (getLayoutManager() instanceof org.eclipse.draw2dl.text.FlowContext)
			((FlowFigure) child)
					.setFlowContext((org.eclipse.draw2dl.text.FlowContext) getLayoutManager());
		revalidateBidi(this);
	}
	 ...
	 * {@link org.eclipse.draw2dl.text.BidiProcessor}, which will process the contributions to determine
	 ...
	 * @see org.eclipse.draw2dl.text.BidiProcessor#add(FlowFigure, String)
	 * @since 3.1
	 */
	 ...
	 */
	protected abstract org.eclipse.draw2dl.text.FlowFigureLayout createDefaultFlowLayout();
