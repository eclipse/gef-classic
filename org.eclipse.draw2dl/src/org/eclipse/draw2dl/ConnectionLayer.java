...
public class ConnectionLayer extends FreeformLayer {
	 ...
	 */
	protected org.eclipse.draw2dl.ConnectionRouter connectionRouter;

	/**
	 * Adds the given figure with the given contraint at the given index. If the
	 * figure is a {@link org.eclipse.draw2dl.Connection}, its {@link org.eclipse.draw2dl.ConnectionRouter} is set.
	 * 
	 * @param figure
	 *            Figure being added
	 * @param constraint
	...
	public void add(org.eclipse.draw2dl.IFigure figure, Object constraint, int index) {
		...
		if (figure instanceof org.eclipse.draw2dl.Connection && getConnectionRouter() != null)
			((org.eclipse.draw2dl.Connection) figure).setConnectionRouter(getConnectionRouter());
	}
	...
	/**
	 * @see org.eclipse.draw2dl.IFigure#paint(org.eclipse.draw2dl.Graphics)
	 */
	...
	/**
	 * Removes the figure from this Layer. If the figure is a {@link org.eclipse.draw2dl.Connection}
	 * , that Connection's {@link org.eclipse.draw2dl.ConnectionRouter} is set to <code>null</code>.
	 * 
	 * @param figure
	...
	public void remove(org.eclipse.draw2dl.IFigure figure) {
		if (figure instanceof org.eclipse.draw2dl.Connection)
			((org.eclipse.draw2dl.Connection) figure).setConnectionRouter(null);
		super.remove(figure);
	}
