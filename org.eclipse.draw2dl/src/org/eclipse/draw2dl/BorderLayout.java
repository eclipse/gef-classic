...
public class BorderLayout extends AbstractHintLayout {
	 ...
	 */
	public static final Integer CENTER = new Integer(org.eclipse.draw2dl.PositionConstants.CENTER);
	/**
	 * Constant to be used as a constraint for child figures
	 */
	public static final Integer TOP = new Integer(org.eclipse.draw2dl.PositionConstants.TOP);
	/**
	 * Constant to be used as a constraint for child figures
	 */
	public static final Integer BOTTOM = new Integer(org.eclipse.draw2dl.PositionConstants.BOTTOM);
	/**
	 * Constant to be used as a constraint for child figures
	 */
	public static final Integer LEFT = new Integer(org.eclipse.draw2dl.PositionConstants.LEFT);
	/**
	 * Constant to be used as a constraint for child figures
	 */
	public static final Integer RIGHT = new Integer(org.eclipse.draw2dl.PositionConstants.RIGHT);

	private org.eclipse.draw2dl.IFigure center, left, top, bottom, right;
	private int vGap = 0, hGap = 0;

	/**
	 * @see org.eclipse.draw2dl.AbstractHintLayout#calculateMinimumSize(org.eclipse.draw2dl.IFigure,
	 *      int, int)
	 */
	protected Dimension calculateMinimumSize(org.eclipse.draw2dl.IFigure container, int wHint,
                                             int hHint) {
	...
	/**
	 * @see org.eclipse.draw2dl.AbstractLayout#remove(org.eclipse.draw2dl.IFigure)
	 */
	 ...
	 * {@link #remove(org.eclipse.draw2dl.IFigure)}.
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * 
	 * @see org.eclipse.draw2dl.AbstractLayout#setConstraint(org.eclipse.draw2dl.IFigure, Object)
	 */
	public void setConstraint(IFigure child, Object constraint) {
		...
		case org.eclipse.draw2dl.PositionConstants.CENTER:
			center = child;
			break;
		case org.eclipse.draw2dl.PositionConstants.TOP:
			top = child;
			break;
		case org.eclipse.draw2dl.PositionConstants.BOTTOM:
			bottom = child;
			break;
		case org.eclipse.draw2dl.PositionConstants.RIGHT:
			right = child;
			break;
