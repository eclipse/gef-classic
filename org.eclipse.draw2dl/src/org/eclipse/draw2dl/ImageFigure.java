...
public class ImageFigure extends AbstractImageFigure {
	 ...
	 */
	public ImageFigure() {
		this(null, org.eclipse.draw2dl.PositionConstants.CENTER);
	}
	...
	public ImageFigure(Image image) {
		this(image, org.eclipse.draw2dl.PositionConstants.CENTER);
	}
	...
	protected void paintFigure(Graphics graphics) {
		...
		switch (alignment & org.eclipse.draw2dl.PositionConstants.NORTH_SOUTH) {
		...
		switch (alignment & org.eclipse.draw2dl.PositionConstants.EAST_WEST) {
