 ...
 * factor.
 */
public class ScaledGraphics extends org.eclipse.draw2dl.Graphics {
	...
	private org.eclipse.draw2dl.Graphics graphics;
	 ...
	 */
	public ScaledGraphics(org.eclipse.draw2dl.Graphics g) {
		graphics = g;
		localFont = g.getFont();
		localLineWidth = g.getLineWidthFloat();
	}

	/** @see org.eclipse.draw2dl.Graphics#clipRect(Rectangle) */
	...
	/** @see org.eclipse.draw2dl.Graphics#drawImage(Image, int, int) */
	...
	/** @see org.eclipse.draw2dl.Graphics#drawImage(Image, int, int, int, int, int, int, int, int) */
	...
	/** @see org.eclipse.draw2dl.Graphics#drawPath(Path) */
	...
	/** @see org.eclipse.draw2dl.Graphics#drawPoint(int, int) */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#drawPolygon(int[])
	 */
	public void drawPolygon(int[] points) {
		graphics.drawPolygon(zoomPointList(points));
	}

	/** @see org.eclipse.draw2dl.Graphics#drawPolygon(PointList) */
	public void drawPolygon(PointList points) {
		graphics.drawPolygon(zoomPointList(points.toIntArray()));
	}

	/**
	 * @see org.eclipse.draw2dl.Graphics#drawPolyline(int[])
	 */
	public void drawPolyline(int[] points) {
		graphics.drawPolyline(zoomPointList(points));
	}

	/** @see org.eclipse.draw2dl.Graphics#drawPolyline(PointList) */
	...
	/** @see org.eclipse.draw2dl.Graphics#drawRoundRectangle(Rectangle, int, int) */
	public void drawRoundRectangle(Rectangle r, int arcWidth, int arcHeight) {
		graphics.drawRoundRectangle(zoomRect(r.x, r.y, r.width, r.height),
				(int) (arcWidth * zoom), (int) (arcHeight * zoom));
	}

	/** @see org.eclipse.draw2dl.Graphics#drawString(String, int, int) */
	public void drawString(String s, int x, int y) {
		if (allowText)
			graphics.drawString(s, zoomTextPoint(x, y));
	}

	/** @see org.eclipse.draw2dl.Graphics#drawText(String, int, int) */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#drawText(String, int, int, int)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#drawTextLayout(TextLayout, int, int, int, int, Color,
	 *      Color)
	 */
	...
	/** @see org.eclipse.draw2dl.Graphics#fillPath(Path) */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#fillPolygon(int[])
	 */
	public void fillPolygon(int[] points) {
		graphics.fillPolygon(zoomPointList(points));
	}

	/** @see org.eclipse.draw2dl.Graphics#fillPolygon(PointList) */
	...
	/** @see org.eclipse.draw2dl.Graphics#fillRoundRectangle(Rectangle, int, int) */
	public void fillRoundRectangle(Rectangle r, int arcWidth, int arcHeight) {
		graphics.fillRoundRectangle(zoomFillRect(r.x, r.y, r.width, r.height),
				(int) (arcWidth * zoom), (int) (arcHeight * zoom));
	}

	/** @see org.eclipse.draw2dl.Graphics#fillString(String, int, int) */
	public void fillString(String s, int x, int y) {
		if (allowText)
			graphics.fillString(s, zoomTextPoint(x, y));
	}

	/** @see org.eclipse.draw2dl.Graphics#fillText(String, int, int) */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#getAbsoluteScale()
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#getAlpha()
	 */
	public int getAlpha() {
	...
	/** @see org.eclipse.draw2dl.Graphics#getClip(Rectangle) */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#getAdvanced()
	 */
	...
	public FontMetrics getFontMetrics() {
		return org.eclipse.draw2dl.FigureUtilities.getFontMetrics(localFont);
	}
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#getInterpolation()
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#getLineCap()
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#getLineJoin()
	 */
	...
	/** @see org.eclipse.draw2dl.Graphics#getLineMiterLimit() */
	...
	/** @see org.eclipse.draw2dl.Graphics#getLineWidthFloat() */
	public float getLineWidthFloat() {
		return getLocalLineWidth();
	}

	/** @see org.eclipse.draw2dl.Graphics#getLineAttributes() */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#getTextAntialias()
	 */
	...
	/** @see org.eclipse.draw2dl.Graphics#rotate(float) */
	...
	/** @see org.eclipse.draw2dl.Graphics#setAdvanced(boolean) */
	public void setAdvanced(boolean advanced) {
		graphics.setAdvanced(advanced);
	}

	/**
	 * @see org.eclipse.draw2dl.Graphics#setAlpha(int)
	 */
	...
	/** @see org.eclipse.draw2dl.Graphics#setBackgroundColor(Color) */
	public void setBackgroundColor(Color rgb) {
		graphics.setBackgroundColor(rgb);
	}

	/** @see org.eclipse.draw2dl.Graphics#setClip(Path) */
	...
	/** @see org.eclipse.draw2dl.Graphics#setBackgroundPattern(Pattern) */
	public void setBackgroundPattern(Pattern pattern) {
		graphics.setBackgroundPattern(pattern);
	}

	/** @see org.eclipse.draw2dl.Graphics#setClip(Rectangle) */
	public void setClip(Rectangle r) {
		graphics.setClip(zoomClipRect(r));
	}

	/**
	 * @see org.eclipse.draw2dl.Graphics#clipPath(org.eclipse.swt.graphics.Path)
	 */
	...
	/** @see org.eclipse.draw2dl.Graphics#setFont(Font) */
	public void setFont(Font f) {
		setLocalFont(f);
	}

	/** @see org.eclipse.draw2dl.Graphics#setForegroundColor(Color) */
	public void setForegroundColor(Color rgb) {
		graphics.setForegroundColor(rgb);
	}

	/** @see org.eclipse.draw2dl.Graphics#setForegroundPattern(Pattern) */
	public void setForegroundPattern(Pattern pattern) {
		graphics.setForegroundPattern(pattern);
	}

	/** @see org.eclipse.draw2dl.Graphics#setInterpolation(int) */
	public void setInterpolation(int interpolation) {
		graphics.setInterpolation(interpolation);
	}

	/**
	 * @see org.eclipse.draw2dl.Graphics#setLineCap(int)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#setLineDash(int[])
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#setLineDash(float[])
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#setLineDashOffset(float)
	 */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#setLineJoin(int)
	 */
	...
	/** @see org.eclipse.draw2dl.Graphics#setLineMiterLimit(float) */
	...
	/** @see org.eclipse.draw2dl.Graphics#setLineWidthFloat(float) */
	public void setLineWidthFloat(float width) {
		setLocalLineWidth(width);
	}

	/** @see org.eclipse.draw2dl.Graphics#setLineAttributes(LineAttributes) */
	...
	/**
	 * @see org.eclipse.draw2dl.Graphics#setTextAntialias(int)
	 */
