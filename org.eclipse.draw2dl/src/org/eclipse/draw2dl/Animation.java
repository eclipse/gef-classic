...
public class Animation {
	...
	static class AnimPair {
		...
		final org.eclipse.draw2dl.Animator animator;
		final org.eclipse.draw2dl.IFigure figure;

		AnimPair(org.eclipse.draw2dl.Animator animator, org.eclipse.draw2dl.IFigure figure) {
	 ...
	 * @since 3.2
	 */
	public static Object getFinalState(org.eclipse.draw2dl.Animator animator, org.eclipse.draw2dl.IFigure figure) {
	 ...
	 * @since 3.2
	 */
	public static Object getInitialState(org.eclipse.draw2dl.Animator animator, org.eclipse.draw2dl.IFigure figure) {
	...
	static void hookAnimator(org.eclipse.draw2dl.IFigure figure, org.eclipse.draw2dl.Animator animator) {
		AnimPair pair = new AnimPair(animator, figure);
		if (figureAnimators.add(pair))
			animator.init(figure);
	}

	static void hookNeedsCapture(org.eclipse.draw2dl.IFigure figure, org.eclipse.draw2dl.Animator animator) {
		AnimPair pair = new AnimPair(animator, figure);
		if (figureAnimators.contains(pair))
			toCapture.add(pair);
	}

	static boolean hookPlayback(org.eclipse.draw2dl.IFigure figure, org.eclipse.draw2dl.Animator animator) {
	...
	static void putFinalState(org.eclipse.draw2dl.Animator animator, org.eclipse.draw2dl.IFigure key, Object state) {
