...
public class GeometryTest extends TestCase {
	...
	public void testLinesIntersect() {
		...
		assertFalse("Line segments are non-parallel and do not cross and should thus not be regarded as intersecting.",
				Geometry.linesIntersect(0, 0, 2, 2, 0, 1, 0, 2));

		// parallel
		assertFalse("Line segments are parallel but not co-linear and should thus not be regarded as intersecting.",
		...
		assertTrue("Line segments are co-linear, sharing ending/starting point.",
				Geometry.linesIntersect(0, 0, 5, 5, 5, 5, 6, 6));
		assertTrue("Line segments are co-linear, sharing starting/ending point.",
				Geometry.linesIntersect(3, 3, 6, 6, 0, 0, 3, 3));
		assertFalse("Line segments are co-linear but non-overlapping, and should thus not be regarded as intersecting.",
