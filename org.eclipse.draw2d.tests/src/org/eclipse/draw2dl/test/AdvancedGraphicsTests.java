...
public class AdvancedGraphicsTests extends TestCase {
	...
	private org.eclipse.draw2dl.SWTGraphics g;
	...
	public void testAntialias() {
		...
		tests[0] = new AntialiasSettings(SWT.ON, SWT.ON, org.eclipse.draw2dl.ColorConstants.red);
		tests[1] = new AntialiasSettings(SWT.OFF, SWT.OFF, org.eclipse.draw2dl.ColorConstants.blue);
		tests[2] = new AntialiasSettings(SWT.DEFAULT, SWT.ON,
				org.eclipse.draw2dl.ColorConstants.black);
		tests[3] = new AntialiasSettings(SWT.ON, SWT.DEFAULT,
				org.eclipse.draw2dl.ColorConstants.darkGreen);
	...
	public void testFillRules() {
		...
		g.setBackgroundColor(org.eclipse.draw2dl.ColorConstants.red);
		g.pushState();
	...
	public void testPatterns() {
		...
		resources.push(f);
		g.setFont(f);
		g.setBackgroundColor(org.eclipse.draw2dl.ColorConstants.yellow);
		g.pushState();

		Pattern gradient = new Pattern(null, 0, 0, 80, 40, org.eclipse.draw2dl.ColorConstants.gray,
				ColorConstants.black);
