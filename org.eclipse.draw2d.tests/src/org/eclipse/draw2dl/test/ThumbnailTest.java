...
public class ThumbnailTest extends TestCase {
	...
	public void test_Thumbnail() {
		...
		org.eclipse.draw2dl.IFigure fig = new org.eclipse.draw2dl.Ellipse();
		fig.setBounds(new org.eclipse.draw2dl.geometry.Rectangle(0, 0, 100, 100));
		fig.setFont(Display.getDefault().getSystemFont());
		thumb.setSource(fig);
		thumb.setBounds(new org.eclipse.draw2dl.geometry.Rectangle(0, 0, 100, 100));
