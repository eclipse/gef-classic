...
import org.eclipse.gef3.examples.flow.model.commands.DeleteConnectionCommand;
import org.eclipse.gef3.examples.flow.model.commands.SplitTransitionCommand;
import org.eclipse.gef3.examples.flow.parts.TransitionPart;
...
public class TransitionEditPolicy extends ConnectionEditPolicy {
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.ConnectionEditPolicy#getCommand(org.eclipse.gef3.Request)
	 */
	...
	/**
	 * @see ConnectionEditPolicy#getDeleteCommand(GroupRequest)
	 */
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.AbstractEditPolicy#getTargetEditPart(org.eclipse.gef3.Request)
	 */
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.AbstractEditPolicy#eraseTargetFeedback(org.eclipse.gef3.Request)
	 */
	...
	/**
	 * @see org.eclipse.gef3.editpolicies.AbstractEditPolicy#showTargetFeedback(org.eclipse.gef3.Request)
	 */
