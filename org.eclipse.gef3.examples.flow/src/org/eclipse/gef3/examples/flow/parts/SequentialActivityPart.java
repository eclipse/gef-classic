...
public class SequentialActivityPart extends StructuredActivityPart {
	...
	/**
	 * @see org.eclipse.gef3.examples.flow.parts.StructuredActivityPart#createFigure()
	 */
	...
	/**
	 * @see org.eclipse.gef3.examples.flow.parts.StructuredActivityPart#getAnchorOffset()
	 */
	int getAnchorOffset() {
		return 15;
	}
