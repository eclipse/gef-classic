...
public class GraphViewerTests extends Assert {
	...
	public void testCreateFromGraph() {
		...
		GraphViewer v = new GraphViewer(g, SWT.NONE);
	...
	public void testFindGraphItem() {
		Assert.assertNull("If an item cannot be found, the viewer should return null", //$NON-NLS-1$
	...
	static class SampleGraphEntityContentProvider implements IGraphEntityContentProvider {
		...
		public static double getWeight(Object entity1, Object entity2) {
			return 0;
		}
