 ...
 */
public class TreeBranch extends org.eclipse.draw2dl.Figure {
 ...
 */
public void setBounds(org.eclipse.draw2dl.geometry.Rectangle rect) {
...
/*
 * A layer is being used simply because it is the only "transparent" figure in draw2dl. See
...
org.eclipse.draw2dl.IFigure node;
int style;

public TreeBranch(org.eclipse.draw2dl.IFigure title) {
	this(title, STYLE_NORMAL);
}

public TreeBranch(org.eclipse.draw2dl.IFigure title, int style) {
	setStyle(style);
...
public void animationReset(org.eclipse.draw2dl.geometry.Rectangle bounds) {
	...
	org.eclipse.draw2dl.geometry.Rectangle r = node.getBounds();
...
public void collapse() {
	...
	org.eclipse.draw2dl.IFigure root = this;
	org.eclipse.draw2dl.Viewport port = null;
	org.eclipse.draw2dl.geometry.Point viewportStart = null;
	while (root.getParent() != null) {
		if (root instanceof org.eclipse.draw2dl.Viewport)
			port = ((Viewport)root);
		root = root.getParent();
	}
...
/**
 * @see org.eclipse.draw2dl.Figure#containsPoint(int, int)
 */
...
public org.eclipse.draw2dl.IFigure getContentsPane() {
	return contents;
}
...
/**
 * @see org.eclipse.draw2dl.Figure#getMinimumSize(int, int)
 */
public org.eclipse.draw2dl.geometry.Dimension getMinimumSize(int wHint, int hHint) {
	if (!Animation.PLAYBACK)
		validate();
	return super.getMinimumSize(wHint, hHint);
}

public org.eclipse.draw2dl.IFigure getNode() {
	return node;
}
...
/**
 * @see org.eclipse.draw2dl.Figure#paintFigure(org.eclipse.draw2dl.Graphics)
 */
...
public void setNode(org.eclipse.draw2dl.IFigure node) {
	remove(this.node);
	add(this.node, 0);
}
...
public void validate() {
	...
	if (style == STYLE_HANGING) {
		org.eclipse.draw2dl.ToolbarLayout layout = new org.eclipse.draw2dl.ToolbarLayout(!getRoot().isHorizontal()) {
