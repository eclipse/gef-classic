...
public class GridLayoutExample extends AbstractExample {
	...
	org.eclipse.draw2dl.Figure container;
	Composite composite;
	org.eclipse.draw2dl.GridLayout gridLayout;
	...
	org.eclipse.draw2dl.Shape selectedShape = null, prevSelectedShape = null;
	int shapeCount = 0;
	int colorCount = 0;
	Color colors[] = new Color[] { org.eclipse.draw2dl.ColorConstants.blue, org.eclipse.draw2dl.ColorConstants.red,
			org.eclipse.draw2dl.ColorConstants.yellow, org.eclipse.draw2dl.ColorConstants.gray, org.eclipse.draw2dl.ColorConstants.green,
			org.eclipse.draw2dl.ColorConstants.lightBlue, org.eclipse.draw2dl.ColorConstants.cyan,
			org.eclipse.draw2dl.ColorConstants.darkGreen, ColorConstants.orange };
	...
	protected IFigure getContents() {
		...
		container.addMouseListener(new org.eclipse.draw2dl.MouseListener.Stub() {
		...
		org.eclipse.draw2dl.Shape shape = createShape();
		container.add(shape);
	...
	protected org.eclipse.draw2dl.Shape createShape() {
		org.eclipse.draw2dl.Shape shape = null;
		if (shapeCount == 0)
			shape = new org.eclipse.draw2dl.Ellipse();
		else if (shapeCount == 1)
			shape = new org.eclipse.draw2dl.RectangleFigure();
		else if (shapeCount == 2)
			shape = new org.eclipse.draw2dl.RoundedRectangle();
		else if (shapeCount == 3)
			shape = new RectangleFigure();
		else if (shapeCount == 4)
			shape = new Ellipse();
		else if (shapeCount == 5)
			shape = new org.eclipse.draw2dl.Triangle();
		...
		shape.addMouseListener(new MouseListener.Stub() {
			public void mousePressed(MouseEvent event) {
				...
				org.eclipse.draw2dl.GridData d = (org.eclipse.draw2dl.GridData) gridLayout.getConstraint(selectedShape);
