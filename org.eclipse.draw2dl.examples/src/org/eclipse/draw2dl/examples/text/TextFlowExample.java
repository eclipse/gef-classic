...
/**
 * This example shows the basic ways that the draw2dl.text figures can be used.
 * 
 * @author hudsonr
 * @since 2.0
 */
...
static protected org.eclipse.draw2dl.IFigure createAlignmentParagraph() {
...
static protected org.eclipse.draw2dl.IFigure createBaselineParagraph() {
	BlockFlow block = new BlockFlow();
...
static protected org.eclipse.draw2dl.IFigure createBlockParagraph() {
...
static protected org.eclipse.draw2dl.IFigure createNestedInlineParagraph() {
	BlockFlow blockFlow = new BlockFlow();
	TextFlow text;
	blockFlow.add(new TextFlow("A paragraph can contain multiple children, including"
	  + " nested structure using InlineFlows. "));
	
	org.eclipse.draw2dl.text.InlineFlow inline = new InlineFlow();
	inline.setForegroundColor(org.eclipse.draw2dl.ColorConstants.darkBlue);
...
static protected org.eclipse.draw2dl.IFigure createParagraph() {
	BlockFlow blockFlow = new BlockFlow();
	TextFlow contents = new TextFlow();
...
static protected org.eclipse.draw2dl.IFigure createTitle() {
	BlockFlow blockFlow = new BlockFlow();
...
/**
 * @see AbstractExample#setFigureCanvas(org.eclipse.draw2dl.FigureCanvas)
 */
