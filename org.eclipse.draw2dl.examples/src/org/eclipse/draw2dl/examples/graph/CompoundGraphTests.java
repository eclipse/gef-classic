...
import org.eclipse.draw2dl.graph.CompoundDirectedGraphLayout;
...
public class CompoundGraphTests {
	...
	public static CompoundDirectedGraph chains(int direction) {
		...
		s1.setPadding(new org.eclipse.draw2dl.geometry.Insets(10));
		s1.innerPadding = new org.eclipse.draw2dl.geometry.Insets(1);
