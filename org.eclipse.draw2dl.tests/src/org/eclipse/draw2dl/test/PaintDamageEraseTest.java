...
public class PaintDamageEraseTest extends TestCase implements UpdateListener {
	...
	protected org.eclipse.draw2dl.IFigure insideBox;
	protected org.eclipse.draw2dl.geometry.Rectangle lastDamaged;
	protected Display d;
	...
	protected void doIndividualSetup(boolean useRelativeCoordinates) {
		if (useRelativeCoordinates) {
			...
			container = new org.eclipse.draw2dl.RectangleFigure();
		}

		container.setBackgroundColor(org.eclipse.draw2dl.ColorConstants.red);
		container.setBorder(new MarginBorder(15));

		insideBox = new org.eclipse.draw2dl.RectangleFigure();
		...
		if (useRelativeCoordinates) {
			insideBox.setBounds(new org.eclipse.draw2dl.geometry.Rectangle(10, 10, 25, 25));
		} else {
			insideBox.setBounds(new org.eclipse.draw2dl.geometry.Rectangle(25, 25, 25, 25));
		}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.draw2dl.UpdateListener#notifyValidating()
	 */
