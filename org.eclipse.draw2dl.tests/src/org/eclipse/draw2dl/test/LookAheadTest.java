...
public class LookAheadTest extends BaseTestCase {
	...
	org.eclipse.draw2dl.text.TextFlow simpleText;

	private int[] width;
	private org.eclipse.draw2dl.text.FlowPage flowpage;
	private org.eclipse.draw2dl.text.BlockFlow paragraph1;
	private org.eclipse.draw2dl.text.TextFlow p1text1;
	private org.eclipse.draw2dl.text.InlineFlow p1inline;
	private org.eclipse.draw2dl.text.InlineFlow p1NestedInline;
	private org.eclipse.draw2dl.text.TextFlow p1text2;
	private org.eclipse.draw2dl.text.BlockFlow paragraph2;
	private org.eclipse.draw2dl.text.TextFlow p2text1;
	private org.eclipse.draw2dl.text.TextFlow p1text3;
	...
	protected void setUp() throws Exception {
		simpleText = new org.eclipse.draw2dl.text.TextFlow();
		...
		flowpage.add(new org.eclipse.draw2dl.text.TextFlow("Heading 1"));
		flowpage.add(paragraph1 = new org.eclipse.draw2dl.text.BlockFlow());
		flowpage.add(new org.eclipse.draw2dl.text.TextFlow("Heading 2"));
		flowpage.add(paragraph2 = new BlockFlow());

		paragraph1.add(p1text1 = new org.eclipse.draw2dl.text.TextFlow("The quick "));
		paragraph1.add(p1inline = new org.eclipse.draw2dl.text.InlineFlow());
		p1inline.add(p1NestedInline = new org.eclipse.draw2dl.text.InlineFlow());
		p1NestedInline.add(p1text2 = new org.eclipse.draw2dl.text.TextFlow("brown fox"));
		paragraph1.add(p1text3 = new org.eclipse.draw2dl.text.TextFlow("jumped over"));

		paragraph2.add(p2text1 = new org.eclipse.draw2dl.text.TextFlow("Hel"));
		paragraph2.add(new org.eclipse.draw2dl.text.TextFlow(""));
	...
	org.eclipse.draw2dl.text.FlowContext getContext(org.eclipse.draw2dl.text.FlowFigure figure) {
