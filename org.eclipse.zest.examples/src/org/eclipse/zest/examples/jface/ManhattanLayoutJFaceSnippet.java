/*******************************************************************************
 * Copyright 2005-2007, 2023 CHISEL Group, University of Victoria, Victoria, BC, Canada.
 *
...
public class ManhattanLayoutJFaceSnippet {
	...
	static class MyEndpointEntityLabelProvider extends LabelProvider implements IEntityConnectionStyleProvider {
		final Image image = Display.getDefault().getSystemImage(SWT.ICON_WARNING);
