...
public interface IGraphModelFactory {
	...
	public abstract Graph createModelFromContentProvider(
	 ...
	 */
	public abstract IGraphConnection createRelationship(Graph model,
			Object data);
	 ...
	 */
	public abstract IGraphNode createNode(Graph model, Object data);
