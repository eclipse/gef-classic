/*******************************************************************************
 * Copyright (c) 2009-2010, 2023 Mateusz Matela and others.
 *
...
public class TriangleSubgraph extends FigureSubgraph {
	...
	private class IsoscelesTriangle extends Shape {
		...
		private final PointList points = new PointList(3);
	...
	protected void updateFigure() {
		...
		double avgNumOfChildrenInSugbraph = (numOfNodesWithChildrenInSubgraph > 0)
				? (double) nodes.size() / numOfNodesWithChildrenInSubgraph
				: 1;
		int r = (int) (parameters.color.getRed()
				+ ((double) 255 - parameters.color.getRed()) / avgNumOfChildrenInSugbraph);
		int g = (int) (parameters.color.getGreen()
