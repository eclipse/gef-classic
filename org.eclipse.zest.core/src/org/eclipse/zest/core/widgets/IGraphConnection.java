...
/**
 * Abstraction of connections in the graph model to allow for a common interface
...
public interface IGraphConnection extends IGraphItem, LayoutRelationship {
	...
	/**
	 * Something has changed with the curve, i.e. its depth or its bezier
	 * coordinates
	 */
	...
	/**
	 * Returns the connection figure for this connection
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the depth of the curve on this connection. Normally ignored
	 * unless the style has ZestStyles.CONNECTIONS_CURVED set.
	 * 
	...
	/**
	 * Returns the start angle for this connection. Used for connections that
	 * have ZestStyles.CONNECTIONS_BEZIER set.
	 * 
	...
	/**
	 * Returns the start length for this connection. Used for connections that
	 * have ZestStyles.CONNECTIONS_BEZIER set.
	 * 
	...
	/**
	 * Returns the end length for this connection. Used for connections that
	 * have ZestStyles.CONNECTIONS_BEZIER set.
	 * 
	 ...
	 * 
	 * @param color
	 *            the color that is used when this connection is highlighted.
	 */
	 ...
	 * 
	 * @param c
	 *            the line color that is used for this connection.
	 */
	void setLineColor(Color c);

	/**
	 * Temporarily changes the line color that is used for this connection. Used
	 * as an intermediary step for highlighting, and other graphical changes.
	 * 
	 * @return the line color that is used for this connection.
	 */
	 ...
	 * 
	 * @param style
	 *            the line style for this connection, based on the SWT line
	 *            styles.
	 * @see SWT.LINE_SOLID
	 * @see SWT.LINE_DASH
	 * @see SWT.LINE_DOT
