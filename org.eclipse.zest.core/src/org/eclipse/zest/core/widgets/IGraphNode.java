...
/**
 * An abstraction of nodes in the graph model to allow different kinds of nodes
...
public interface IGraphNode extends IGraphItem, LayoutEntity {
	...
	public static final String NODE_FIGURE_PROP = "GraphModelNode.NodeFigure";
	...
	/**
	 * Returns a list of {@link IGraphConnection}s that have this node as their
	 * source.
	 * 
	 * @return a list of {@link IGraphConnection}s that have this node as their
	 *         source.
	 */
	...
	/**
	 * Removes the given connection from this node, if it is connected to this
	 * node.
	 * 
	 * @param conn
	 ...
	 * 
	 * @param hasPreferredLocation
	 *            whether or not this node has a preferred location.
	 */
	 ...
	 * 
	 * @param c
	 *            the color that will be used to highlight adjacent nodes.
	 */
	void setHighlightAdjacentColor(Color c);

	/**
	 * Sets whether or not this node should highlight its adjacent
	 * nodes/connections.
	 * 
	 * @param highlightAdjacent
	 *            whether or not this node should highlight its adjacent
	 *            nodes/connections.
	 */
	 ...
	 * 
	 * @param c
	 *            the highlight color for this node.
	 */
	 ...
	 * 
	 * @param x
	 *            the preferred x location.
	 * @param y
	 *            the preferred y location.
	 */
	...
	/**
	 * Sets a new node figure for this node
	 * 
	 * @param nodeFigure
	 */
	 ...
	 *            the connection
	 * @param source
	 *            true if the connection should be added as a source, false if
	 *            it should be added as a target.
	 * @deprecated
	 */
