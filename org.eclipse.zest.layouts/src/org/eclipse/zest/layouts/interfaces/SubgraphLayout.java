...
public interface SubgraphLayout extends EntityLayout {
	...
	/**
	 * Returns all the nodes belonging to this subgraph. Replacing elements in the
	 * returned array does not affect this subgraph.
	 *
	 ...
	 * graph. If this method returns false, it means that this subgraph will not be
	 * visible so all methods related to location, size and direction should be
	 * ignored.
	 *
	 * @return whether or not this subgraph is a graph entity that should be laid
	 *         out.
	 */
	...
	/**
	 * Sets the direction of this subgraph (does nothing in case of subgraphs that
	 * don't depend on direction)
	 *
	 * @param direction one of constants: {@link #TOP_DOWN}, {@link #BOTTOM_UP},
