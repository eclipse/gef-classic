/*******************************************************************************
 * Copyright (c) 2009, 2023 Mateusz Matela and others. All rights reserved.
 *
...
public interface NodeLayout extends EntityLayout {
	...
	/**
	 *
	 * @return a subgraph this node belongs to or null if this node is not pruned
	 */
	public SubgraphLayout getSubgraph();

	/**
	 *
	 * @param subgraph a subgraph this node should belong to or null if this node
	 ...
	 *
	 * @param minimized new minimized state
	 */
