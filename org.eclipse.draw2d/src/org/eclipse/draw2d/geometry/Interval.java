...
public class Interval implements Serializable {
	...
	public String toString() {
		return "Interval(" + begin + ", " + length + ")"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
	...
	/**
	 * Returns <code>true</code> if the input {@link Interval} intersects this
	 * {@link Interval}.
	 */
	...
	/**
	 * Changes begin, but does not change end position of interval, so also changes
	 * length.
	 */
	...
	/**
	 * Increase the interval into leading direction (ex., grow left for horizontal
	 * interval).
	 *
	...
	/**
	 * Increase the interval into trailing direction (ex., grow right for horizontal
	 * interval).
	 *
	 * @param delta the value to increase the interval to.
	 */
	...
	/**
	 * Moves begin with given delta. End point of interval does not move, so we
	 * change also length.
	 *
	...
	/**
	 * Moves end with given delta. Begin point of interval does not move, so
	 * practically we just change length.
	 *
