 ...
 * {@link SchemeBorder.Scheme Scheme} called {@link ButtonScheme ButtonScheme}
 ...
 * figures like buttons. Though similar to the {@link SchemeBorder.Scheme Scheme}
 * it supports an extra set of borders for the pressed states. 
 */
	...
	extends Scheme
{
	...
	/**
	 * Constructs a new button scheme where the input colors are
	 * the colors for the top-left and bottom-right sides of the 
	 * border. These colors serve as the colors when the border
	 * is in a pressed state too. The width of each side is determined
	 * by the number of colors passed in as input.
	 *
	 ...
	 * Constructs a new button scheme where the input colors are
	 * the colors for the top-left and bottom-right sides of the 
	 * border, for the normal and pressed states.  The width of 
	 * each side is determined by the number of colors passed in 
	 * as input. 
	 *
	 ...
	 * are based on the number of normal and pressed, highlight and
	 * shadow colors.
	 *
	 ...
	 * <ul>
	 *	<li> The number of highlight colors is different than the
	 *       the number of shadow colors.
	 *  <li> The number of pressed highlight colors is different than
	 *       the number of pressed shadow colors.
	 *  <li> Any of the highlight and shadow colors are set to 
	 *       <code>null</code>
	 *  <li> Any of the pressed highlight and shadow colors are
	 *       set to <code>null</code> 
	 * </ul>
	 * This is done so that the entire region under the figure
	 * is properly covered.
	 *
 ...
 * as its Scheme.
 *
 * @param scheme  Button Scheme for this ButtonBorder.
 * @since 2.0
 */
...
/* 
 * Paints this border with the help of the set scheme, the
 * model of the clickable figure, and other inputs. The scheme
 * is used in conjunction with the state of the model to get 
