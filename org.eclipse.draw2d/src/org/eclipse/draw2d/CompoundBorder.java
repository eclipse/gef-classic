 ...
 * <i>inner</i> and <i>outer</i> borders.
 */
public class CompoundBorder
	extends AbstractBorder
{
protected Border inner, outer;
...
/*
 * Returns whether this border is opaque or not. Return value
 * is dependent on the opaque state of both the borders it 
 * contains. Both borders have to be opaque for this border to
 * be opaque. In the absence of any of the borders, this border
 * is not opaque.
 */
