...
public interface Border {
	 ...
	 * {@link IFigure#getBounds()}, inset by the parameter <i>insets</i>. The border
	 * generally should not paint inside its own insets. More specifically, Border
	 * <i>b</i> should paint inside the rectangle:
