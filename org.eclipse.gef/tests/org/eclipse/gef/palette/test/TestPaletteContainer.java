...
public PaletteRoot createLogicPalette1(){
	...
	PaletteRoot paletteRoot = new PaletteRoot(rootChildren);
	
	PaletteCategory cat1 = new PaletteCategory("Category1");
	List cat1Children = new java.util.ArrayList();

	PaletteEntry pe1 = new PaletteEntry("LED", "Create an LED", 
		ImageDescriptor.createFromFile(TestSliderPalette.class,"icons/circuit16.gif").createImage(), 
		ImageDescriptor.createFromFile(TestSliderPalette.class,"icons/circuit16.gif").createImage());
	cat1Children.add(pe1);
	
	PaletteCategory cat1cat1 = new PaletteCategory("Category1-Sub1");
	List cat1cat1Children = new java.util.ArrayList();
	
	pe1 = new PaletteEntry("Circuit", "Create an Circuit", 
		ImageDescriptor.createFromFile(TestSliderPalette.class,"icons/circuit16.gif").createImage(), 
		ImageDescriptor.createFromFile(TestSliderPalette.class,"icons/circuit16.gif").createImage());
	...
	pe1 = new PaletteEntry("Circuit", "Create an Circuit", 
		...
		ImageDescriptor.createFromFile(TestSliderPalette.class,"icons/circuit16.gif").createImage());
	cat1cat1Children.add(pe1);
	PaletteGroup cat1cat1grp1 = new PaletteGroup("Group1");
	List cat1cat1grp1Children = new java.util.ArrayList();
	pe1 = new PaletteEntry("LED", "Create an LED", 
	...
	PaletteCategory cat1cat1cat1grp1cat1 = new PaletteCategory("Category1");
	List cat1cat1cat1grp1cat1Children = new java.util.ArrayList();
	pe1 = new PaletteEntry("AND", "Create an AND", 
	...
	pe1 = new PaletteEntry("XOR", "Create an XOR", 
	...
	cat1.addAll(cat1Children);
	cat1cat1.addAll(cat1cat1Children);
	cat1cat1grp1.addAll(cat1cat1grp1Children);
	cat1cat1cat1grp1cat1.addAll(cat1cat1cat1grp1cat1Children);
	paletteRoot.addAll(rootChildren);
