...
static {
	...
	MarqueeTool_Desc = rb.getString("MarqueeTool.Desc"); //$NON-NLS-1$
	MarqueeTool_Nodes_Desc = rb.getString("MarqueeTool.N.Desc"); //$NON-NLS-1$
	MarqueeTool_Connections_Desc = rb.getString("MarqueeTool.C.Desc"); //$NON-NLS-1$
