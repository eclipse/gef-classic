...
public interface MouseWheelHandler {
	 ...
	 * MouseWheelHandler registered with such a key would only be asked to handle
	 * mouse-wheel events that have the same stateMask as the one that was used to
	 * generate the key.
	 *
	 * @author Pratik Shah
	 * @since 3.1
	...
	public class KeyGenerator {
		/**
		 * The returned String is guaranteed to be equal for two different invocations
		 * with the same stateMask.
		 * <p>
		 * Valid stateMasks are SWT.NONE, SWT.CTRL, SWT.COMMAND, SWT.ALT, SWT.SHIFT,
		 * SWT.MOD1, SWT.MOD2, SWT.MOD3, SWT.MOD4, SWT.BUTTON* or any combination
		 * thereof.
		 *
