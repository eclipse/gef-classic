...
public class GuideLayer extends FreeformLayer {
	 ...
	 * @return the constraint (Boolean indicating whether or not it is horizontal)
	 *         set for the given IFigure; <code>null</code>, if none exists
	 */
	...
	public Rectangle getFreeformExtent() {
		 ...
		 * enough to include the highest and the lowest horizontal guide lines, and wide
		 * enough to include the leftmost and the rightmost vertical guide lines. They
		 * always include the point 5,5 and are further expanded by 5-pixels in all
		 * directions so that none of the guide lines are on the edge.
		 */
		/*
