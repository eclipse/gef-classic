 ...
 * EditParts}. EditParts are the unit of selection in GEF. When selection
 * changes, Accessibility clients are notified. These clients then query the
 * EditPartViewer for various accessibility information.
 * <P>
