 ...
 * 		the model, although this is rare.  But it is common for EditPolicies to contribute
 ...
 * 		when to stop.
 * 	<LI>call activate() on the EditParts it manages.  This includes
 * 		its children, and for GraphicalEditParts, its <i>source connections</i>.
 * </UL>
 */
void deactivate();
