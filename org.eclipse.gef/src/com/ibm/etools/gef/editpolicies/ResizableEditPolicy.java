 ...
 *
 * @return com.ibm.etools.gef.commands.ICommand  The command that performs the operation
 * @param commandString java.lang.String The type of command to create
 * @param commandData com.ibm.etools.gef.ICommandData Data needed to create the command
 */
