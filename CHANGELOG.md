...
![SWT line styles](https://www.eclipse.org/gef/newandnoteworthy/images-35/linestyle.png)

### Graphics now implements getAdvanced()

![Anti-aliasing & Alpha](https://www.eclipse.org/gef/newandnoteworthy/images-35/advanced.png)
...
![curved connections](https://www.eclipse.org/gef/newandnoteworthy/images-35/curved.png)
...
![nested content](https://www.eclipse.org/gef/newandnoteworthy/images-35/nested.png)
...
![attach to guide feedback](https://www.eclipse.org/gef/newandnoteworthy/images-30/rulers-guides.gif)

Parts that are attached to a guide will then move with the guide.

![rules, guides, ghost feedback](https://www.eclipse.org/gef/newandnoteworthy/images-30/guide-drag.gif)

A mechanism is available to show or hide rulers.

![ruler options, menu](https://www.eclipse.org/gef/newandnoteworthy/images-30/rulers-menu.jpg)
...
![background grid](https://www.eclipse.org/gef/newandnoteworthy/images-30/grid.gif)
...
![snap to geometry](https://www.eclipse.org/gef/newandnoteworthy/images-30/geometry.gif)
...
![centered resize](https://www.eclipse.org/gef/newandnoteworthy/images-30/centered-resize.gif)
...
![minimized/hidden palette](https://www.eclipse.org/gef/newandnoteworthy/images-30/flyout-hidden.gif)

The user can also pin it open, if so desired.

![opened/shown palette](https://www.eclipse.org/gef/newandnoteworthy/images-30/flyout-context-menu.gif)
...
![palette stacks](https://www.eclipse.org/gef/newandnoteworthy/images-30/palette-stack.gif)
...
![shortest path connection routing](https://www.eclipse.org/gef/newandnoteworthy/images-30/shortestPaths.gif)
...
![connection router property](https://www.eclipse.org/gef/newandnoteworthy/images-30/propertySheet.gif)
...
![match size of figures](https://www.eclipse.org/gef/newandnoteworthy/images-30/matchSize.jpg)
