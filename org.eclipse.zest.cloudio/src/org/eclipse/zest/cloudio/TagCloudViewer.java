...
public class TagCloudViewer extends ContentViewer {
	...
	/**
	 * Create a new TagCloudViewer for the given {@link TagCloud}, which must not be
	 * <code>null</code>.
	 *
	 * @param cloud
	 */
	...
	/**
	 * Initialize the default tag cloud listeners. Can be overridden to modify the
	...
	/**
	 * Initialize default selection behaviour: Words can be selected by mouse click,
	 * and selection listeners are notified when the selection changed.
	 */
	...
	/**
	 * Returns the currently selected elements, as an {@link IStructuredSelection}.
	 * Returns an empty selection if no elements are selected.
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.eclipse.jface.viewers.Viewer#setSelection(org.eclipse.jface.viewers.
	 * ISelection, boolean)
	 */
	@Override
	...
	/**
	 * Resets the {@link TagCloud}. If <code>recalc</code> is <code>true</code>, the
	 * displayed elements will be updated with the values provided by used
	 * {@link ICloudLabelProvider}. Otherwise, the cloud will only be re-layouted,
	 * keeping fonts, colors and angles untouched.
	 *
	 * @param monitor
	 * @param recalc
	 */
