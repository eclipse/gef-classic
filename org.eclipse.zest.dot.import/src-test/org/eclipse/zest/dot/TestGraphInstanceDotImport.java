...
public final class TestGraphInstanceDotImport {
	...
	public void edgeLabel() {
		Graph graph = interpreter.create(new Shell(), SWT.NONE,
				"graph Sample{1;2;1->2[label=\"Edge1\"]}");
		Assert.assertNotNull("Created graph must not be null", graph);
		Assert.assertEquals("Edge1", ((GraphConnection) graph.getConnections()
				.get(0)).getText());
	}
	...
	public void edgeStyle() {
		...
		Graph graph = interpreter.create(parent, SWT.NONE,
				"graph Sample{1;2;1->2[style=dashed]}");
		Assert.assertNotNull("Created graph must not be null", graph);
	...
	public void globalEdgeStyle() {
		Shell parent = new Shell();
		Graph graph = interpreter.create(parent, SWT.NONE,
				"graph Sample{edge[style=dashed];1;2;1->2}");
		Assert.assertNotNull("Created graph must not be null", graph);
		Assert.assertEquals(SWT.LINE_DASH, ((GraphConnection) graph
				.getConnections().get(0)).getLineStyle());
		// open(parent);
	...
	public void globalEdgeLabel() {
		Graph graph = interpreter.create(new Shell(), SWT.NONE,
				"graph Sample{edge[label=\"Edge1\"];1;2;1->2}");
		Assert.assertNotNull("Created graph must not be null", graph);
		Assert.assertEquals("Edge1", ((GraphConnection) graph.getConnections()
				.get(0)).getText());
	}
	...
	public void globalNodeLabel() {
		Graph graph = interpreter.create(new Shell(), SWT.NONE,
				"graph Sample{node[label=\"Node1\"];1;}");
		Assert.assertNotNull("Created graph must not be null", graph);
		Assert.assertEquals("Node1",
				((GraphNode) graph.getNodes().get(0)).getText());
	}
	...
	public void layoutSpring() {
		Graph graph = interpreter.create(new Shell(), SWT.NONE,
				"graph Sample{graph[layout=spring];1;}");
		Assert.assertNotNull("Created graph must not be null", graph);
	...
	public void layoutGrid() {
		Graph graph = interpreter.create(new Shell(), SWT.NONE,
				"graph Sample{graph[layout=grid];1;}");
		Assert.assertNotNull("Created graph must not be null", graph);
	...
	public void layoutRadial() {
		Graph graph = interpreter.create(new Shell(), SWT.NONE,
				"graph Sample{graph[layout=radial];1;}");
		Assert.assertNotNull("Created graph must not be null", graph);
	...
	public void layoutTree() {
		Graph graph = interpreter.create(new Shell(), SWT.NONE,
				"graph Sample{graph[layout=tree];1;}");
		Assert.assertNotNull("Created graph must not be null", graph);
	...
	public void faultyLayout() {
		interpreter.create(new Shell(), SWT.NONE,
				"graph Sample{graph[layout=cool];1;}");
	}
